...
Begin VB.Form frmRoserl 
   ...
   Begin RoserlOcx.Roserl cdRoserlEichelA 
      ...
      CardType        =   3
   End
   Begin RoserlOcx.Roserl cdRoserlGrünB 
      Height          =   1860
      Index           =   0
      Left            =   6600
      TabIndex        =   29
      ...
      CardType        =   3
   End
   Begin RoserlOcx.Roserl cdRoserlGrünA 
      Height          =   1860
      Index           =   0
      Left            =   3480
      TabIndex        =   28
   ...
   Begin RoserlOcx.Roserl cdRoserlEichelAss 
      ...
      CardType        =   3
   End
   Begin RoserlOcx.Roserl cdRoserlGrünAss 
      Height          =   1860
      Index           =   0
      Left            =   17760
      TabIndex        =   22
...
'Bei drücken der Tasten Strg+N kann das aktuelle Spiel mit den gleichen Karten noch einmal gespielt werden
'Bei drücken der Tasten Strg+S wird der Lorum-Spielbogen angezeigt
'Bei drücken der Tasten Strg+E kommt eine MsgBox ob das Spiel abgebrochen werden soll
...
'           Lösung: ich lasse sämtliche Bezugnahmen auf ComputerCards weg
'                   und ich benutze für Spieart=Lorum eine eigene Prozedur 'LorumEntladen'
'
...
'           vb6.exe stürzt ab "Visual Basic funktioniert nicht mehr"
...
'09.07.2017 Verbesserung: Bei den ersten zwei Stichen bei spielart = Rot kann die höchste Karte zugegeben werden
'11.07.2017 Verbesserung: bei Spielart=Rot bei den ersten zwei Stichen die höchste Nicht-Rot ausspielen
...
'           Lösung: ich habe www.ActiveVB.de eine Function LoadImageFromCustomRes gefunden da dauert es nur noch 1 Millisek
...
'02.08.2017 Rückgängig machen von 'Lorumkarten aufgedeckt'
'13.08.2017 Fehlerkorrektur
'           Zustand: Wenn der Spieler dran ist, kann er mehr als eine Karte spielen, sooft wie er klickt
'           Lösung: Schalter blnEingesammelt
'13.08.2017 Verbesserung
'           Zustand: In einer MsgBox kann man die Schriftgröße nicht verändern
'           Lösung: Jede MsgBox wird durch eine frmMsgBox ersetzt, dort kann die Schriftgröße klein mittel groß sein
'                   msg wird durch gstrMsg ersetzt
'                   MsgBox wird durch frmMsgBox.Show 1 ersetzt
'                   Die Anzahl Zeilen in gstrMsg wird gezählt - Multiplizieren mit dem Wert für klein/mittel/gross=Form.Height
'                   Die breiteste Zeile in gstrMsg ermitteln - Multiplizieren mit dem Wert für klein/mittel/gross=Form.Width
'                   Die Form in Fenstermitte positionieren - Form.Height \ 2 und Form.Width \ 2
'                   Form sichtbar machen
'                   Die Auswahl von klein mittel groß geschieht in frmFontSize
'                   frmFontSize erreicht man über das Menü
'                   Roserl.ini speichert die gewählte Schriftgröße
'15.08.2017 Verbesserung
'           Zustand: Es ist schwer erkennbar wer ausgespielt hat
'           Lösung:  Der Spielername des Ausspielers wird fett und gelb dargestellt
...
'           Lösung: Alle Karten des Gewinners auf visible = False setzen
'15.08.2017 Fehlerkorrektur
'           Zustand: Schönheitsfehler, Wenn der Spieler die letzte Karte ablegt, bewegt sich diese, aber es liegt noch eine drunter
'           Lösung: Bei Beginn der Bewegungsanimation(EineKarteAblegen) müssen alle Karten cdSpieler(i).Visible = False sein
...
'           Lösung: Bei der letzten Karte bei Spielart=Lorum brauche ich nicht zu sagen, welche Karte das ist
'                   es genügt strAbleger & " legt jetzt seine letzte Karte ab"
'17.08.2017 Verbesserung
'           Nach 4 Durchgängen kommt die Frage 'Willst Du Weiter spielen?'
'22.08.2017 Verbesserung
'           Zustand: Vor dem Sichtbarwerden der Roserl-Karten sieht man kurz alle Karten in halber Groesse
'           Lösung: frmRoserl_Resize zu Beginn Me.Visible = False und am Ende Me.Visible = True
'22.08.2017 Verbesserung
'           Zustand: Wenn Spieler die letzte Karte hinlegt, flackert links davon manchmal noch eine Karte auf
'           Lösung: 'SpielerGespielt.Visible = True' darf erst kommen wenn die Bewegungsanimation bereits begonnen hat
'03.09.2017 Verbesserung
'           Zustand: Wenn nach 4 Spielen weiter gespielt werden soll, wurde der Spielbogen nicht gelöscht
'           Lösung: Call SpielbogenNull war vergessen worden
...
'           Lösung: In der Funktion NachbehandlungAbwerfen muss ich verhindern dass eine einzelne Rot-Karte ermittelt wird, sofern
...
'           Lösung: Der Animations-Startpunkt richtet sich an der Fenstermitte aus
...
'           Lösung: ich habe nicht genug Werte auf Anfangszustand zurückgesetzt
'06.09.2017 Schönheitskorrektur
'           Zustand: Bei Spielbeginn fängt der Computer sofort an Karten auszuspielen.
'           Lösung: Besser ist die Aufforderung "Du musst zum Weiterspielen auf den roten Buchstabe klicken"
...
'           Lösung: If Ausspieler <> Spieler And blnRechtsWarDran = False Then Exit Sub
...
'           Alle MDI-Child-Formen müssen nichtmodal sein. Da kann ich nicht warten bis 'Der Stich geht an ..." auf OK geklickt wird.
'               Nach dem Ausgeben der Nachricht arbeitet das Programm bereits weiter. Klimmzüge sind nötig.
'           Das Menü muss in die MDIForm1 verlegt werden
'           Ich muss Klimmzüge mit frmRoserl_Resize machen
'---------------------------------------------------------------------------------------------------------------------------
'Version 4
...
'           Intuitive Änderung von Me.top durch addition von 5000, sonst saß die Schrift zu weit oben
'---------------------------------------------------------------------------------------------------------------------------
'Version 5
'12.09.2017 Verbesserung
'           Version ins Menü eintragen
'12.09.2017 Verbesserung
'           Spiel beenden, wenn alle Ober gespielt sind oder alle Roten gespielt sind
'13.09.2017 Verbesserung
'           auf Hinweis von Hans-Jürgen Richter gibt es ab sofort eine portable Version
...
'           Zustand: Manchmal ist in der Roserl-Ergebnisliste im ersten Runde alles Null, Einträge beginnen erst ab zweiten Runde
'           Lösung: 'Rundezähler erhöhen war an der falschen Stelle durchgeführt worden
'---------------------------------------------------------------------------------------------------------------------------
'Version 6
'19.09.2017 Fehlerkorrektur
'           Bei Spielart = Lorum hängt sich das Programm auf, sobald das Taskleisten-Icon geklickt wird.
'           Es geht in eine endlose Form_Resize-Schleife
'           Lösung: Ich finde keine bessere Lösung als bei Spielart = Lorum kommt Form_Resize nicht dran
'                   Wieder rückgängig gemacht
'                   Rorm_Resize bei Lorum geht jetzt
'19.09.2017 Fehlerkorrektur
'           Zustand: Der Wert für Stunde ist 2 Stunden zu klein bei Eintragen Bestwerte
'           Lösung: Ich addiere 2 Stunden außer wenn es die 24 überschreiten würde, da addiere ich 1 zum Tag
'20.09.2017 Verbesserung
'           Zustand: Manchmal ist das Spielfeld zu klein. zB bei Resolution kleiner 1920 x 1200 oder bei Lorum
'           Lösung: Ich ordne die LinksKarten und die RechtsKarten entlang des Spielfeldrandes übereinander an
'                   Durch die neue Anordnung überdecken manchmal die RechtsKarten einen Teil der Spielerkarten. Dagegen
'                   hilft ZOrder
'20.09.2017 Verbesserung
'           Zustand: Nach jedem Stich kommt MsgBox "Der Stich geht an..." Mich nervt, dass ich laufend auf OK klicken muss
'           Lösung: Es wird eine Bewegungsanimation der gespielten Karten zum Einsammler hin gemacht
'20.09.2017 Verbesserung
...
'           Kommt schon wieder eine neue MsgBox mit "Schlaf nicht..." das führt zu Fehler 400 eine Modale Form kann nicht geladen
...
'           Lösung: Es wird eine Bewegungsanimation der gespielten Karte zum Zielpunkt hin gemacht
'26.09.2017 Fehlerkorrektur
'           Zustand: Es kommt an falscher Stelle 'Schlaf nicht'
'           Lösung: Besseres ein/ausschalten
'26.09.2017 Verbesserung
'           Zustand: Günter hat kritisiert, dass das Programm des Spielers eventuelle Dummheit korrigiert und Abwärts-Ablegekarten
'                   eigenmächtig ablegt. Wenn der Spieler zu blöd ist, soll ihm das Programm nicht helfen
...
'           Lösung: Der Spieler hat ab sofort die volle Hoheit
'27.09.2017 Zustand: Die bei Lorum animierte Karte versteckt sich hinter den anderen
'           Lösung: Bei MoveKarteLorum wird die animierte Karte mit ZOrder nach oben gelegt
'                   Das ZOrder wirkt offenbar weiter auch bei den nächsten Spielen, da überlagert zB cdMitte(i) die Karte MitteGespielt
'                   Ich muss also auch LinksGespielt MitteGespielt RechtsGespielt mit ZOrder nach oben bringen
'28.09.2017 Zustand: Lorum - Bei mehr als einem Ass wird das nächste kurz mal aufgedeckt, auch bei Beginn einer Kartenfolge
'           Lösung: erst bei MoveKarteLorum wird die zu bewegende Karte aufgedeckt
'28.09.2017 Zustand: Beim 5.Runde müsste 1.Runde dort stehen
'           Lösung: Das war vergessen worden. Das hat bisher noch niemand gemerkt
...
'           Lösung: Ich muss mir die Position aller Lorum-Ablegekarten merken und vor jedem Lorum-Spiel wiederherstellen
...
'           Lösung: Nicht mehr Links und Spieler werden gemessen, sondern nur noch Spieler
'----------------------------------------------------------------------------------------------------------------------------
'Version 8
'04.10.2017 Verbesserung
'           Zustand: Spielart = Lorum Es kommt eine Msgbox
'                   gstrMsg = "Der nächste Ausspieler ist " & strNextPlayer & vbNewLine
'                   gstrMsg = gstrMsg & "Du musst auf die Karten des Ausspielers Klicken" & vbNewLine
'           Das Programm soll selber auf die Karten des Ausspielers klicken, damit wird es noch etwas flüssiger
'           Lösung: zB Call cdLinks_Click(0)
'05.10.2017 Fehlerkorrektur:
'           Zustand: Das Programm soll eine Msgbox bringen "Roserl verlangt eine Bildschirmauflösung von mindestens 1920x1060."
'                   Stattdessen kommt Laufzeitfehler '91' "Objektvariable oder With-Blockvariable nicht festgelegt"
'           Lösung: Vertauschen von
...
'05.10.2017 Fehlerkorrektur
'           Zustand: Bei Menü-Auswahl Schriftgröße kommt Fehler '326' "Ressource mit dem Bezeichner '2536' nicht gefunden"
'           Lösung: Ich hatte Language.res als Projekt-Bestandteil und habe es entfernt
...
'           Lösung: LorumStartWert = LorumStartWert + 1 darf nicht den Wert 9 erreichen
'----------------------------------------------------------------------------------------------------------------------------
'Version 9
...
'               1.links mitte rechts sollten doch etwas schärfer spielen:
'               - die drei werfen im Rot-Spiel kein bzw. kaum rot ab, wenn sie die gespielte Farbe nicht haben.
'           Lösung: Zusätzliche Abfragen, Zuerst die höchste Rot, dann höchste andere Farben abwerfen
...
'                   obwohl alle anderen 6 Schellen schon gespielt sind.Er bekommt mächtig Rot-Karten.
'                   If ComputerCards(I).cGespieltVon = 1 Then 'Falsch
'           Lösung:
'                   If ComputerCards(I).cGespieltVon <> 1 Then 'Richtig
'                   und wenn schon 8 Karten gezählt wurden, dann muss ich diese Farbe beim Weitersuchen überspringen
'14.10.2017 Verbesserung
'           Zustand: Uwe Riedel: bei ROSER wird immer nach dem Drücken des roten Buchstaben ausgespielt, aber bei L nicht.
'                   Und ich habe mir nicht gemerkt, bzw. ich lese es vorher garnicht wer dran ist.
'                   Nun muß ich erst testen wer dran ist. Also bitte auch bei rotes L drücken ausspielen lassen.
'           Lösung: weglassen "Der Lorum-Ausspieler ist " & strAusspieler
...
'           Zustand: Spielart = Rot: Links ist Ausspieler für den 3.Stich und spielt sein höchste Karte aus,
'                   er hätte seine niedrigste suchen müssen
'           Lösung:         If Spielart = Rot And AKIndex < 9 Then                     'falsch
'                           If Spielart = Rot And AKIndex < 8 Then                     'richtig
'                   er hat gedacht er ist noch beim 2.Stich, da wäre es korrekt gewesen
...
'           Lösung: Ich hatte vergessen auch bei den ersten zwei Stichen bei Spielart=Rot/Stiche die Schalter bln...ZEM
'                   ZEM = Zum Ersten Mal auf False zu setzen
'15.10.2017 Verbesserung der Intelligenz
'           Zustand: Bisher wird bei Spielart = Ober und Spielart = RoterKönig keine NachbehandlungAusspieler gemacht, ob vielleicht
'                   eine Farbe ausgespielt werden soll, die keiner mehr hat
'           Lösung: Aufruf von NachbehandlungAusspieler
'15.10.2017 Verbesserung der Intelligenz
'           Zustand: Es ist sinnlos eine Farbe abzuwerfen, die niemand mehr ausspielen kann, außer ich habe keine andere
'           Lösung: Zusätzliche Kontrolle in NachbehandlungAbwerfen -> HatKeinerMehr
'15.10.2017 Verbesserung der Intelligenz
'           Zustand: NachbehandlungAbwerfen will anstelle von DieHöchsteAbwerfen manchmal besser DieEinzigeAbwerfen
'                   wenn es nicht gerade die 7 ist
'           Lösung: wenn es nicht gerade die 7 oder 8 oder 9 ist
'16.10.2017 Verbesserung der Intelligenz
'           Bei Rot oder Stiche
'           Wenn ich der 4.Zugeber(der letzte eines Stiches) bin, muss ich versuchen
'           geradeso unterhalb der höchsten Karte zu bleiben, die auf dem Tisch liegt(3 liegen auf dem Tisch), nicht einfach die niedrigste
'           zugeben -> VorbehandlungRotOderStiche
'16.10.2017 Verbesserung der Intelligenz
'           Wenn der Ober noch nicht gespielt ist und nicht auf dem Tisch liegt
'           und wenn ich der 4.Zugeber(der letzte eines Stiches) bin, kann ich König oder Ass zugeben
'           nicht einfach die niedrigste zugeben, sondern die höchste suchen -> VorbehandlungOber
'16.10.2017 Verbesserung der Intelligenz
'           Wenn der RoterKönig noch nicht gespielt ist und nicht auf dem Tisch liegt
'           und wenn ich der 4.Zugeber(der letzte eines Stiches) bin, kann ich Ass zugeben
'           nicht einfach die niedrigste zugeben, sondern die höchste suchen -> VorbehandlungRoterKönig
'----------------------------------------------------------------------------------------------------------------------------
'Version 10
'20.10.2017 Verbesserung des flüssigen Spiels
'           Zustand: Bei Spielart = Lorum muss nach jedem Ass vom Spieler geklickt werden. Das soll das Programm übernehmen
'           Lösung: Ich benutze den Timer TimerWeiterspielenNachAss
'23.10.2017 Verbesserung:
'           Zustand: Das Beenden über das Schließkreuz funktioniert nur selten
'           Lösung: End benutzen, damit wird es auch nicht besser
'02.11.2017 Fehlerkorrektur
'           Zustand: EintragenBestwerte: Nach Ende der Sommerzeit ist die Uhrzeit eine Stunde höher als wirklich
'           Lösung: Function GMTDiff()
'04.11.2017 Verbesserung der Intelligenz
'           Zustand: Bei Spielart = Rot fehlt es immer noch an Intelligenz beim Ausspielen
'           Lösung: Zuerst nach Rot9 oder Rot8 oder Rot7 suchen
'08.11.2017 Verbesserung der Flüssigkeit
'           Versuche gegen das Flackern bei der Bewegungsanimation
'           MaxDoEvents darf nicht >=2 sein
'09.11.2017 Verbesserung der Flüssigkeit
'           Weitere Versuche gegen das Flackern bei der Bewegungsanimation
'           Bewegungsanimation nicht mit unterschiedlich vielen DoEvents und unterschiedlich vielen Schleifendurchläufen
...
'           Lösung: mit Timer geht es auf allen Computern ungefähr gleich
'----------------------------------------------------------------------------------------------------------------------------
'Version 11
'14.11.2017 Verbesserung
'           Zustand: Bestwerte löschen geht bisher nur manuell durch Bearbeiten der Datei RoserlBestwerte.log
'           Lösung: Button 'Bestwerte löschen' in der Form frmBestwerteZeigen löscht die Datei RoserlBestwerte.log und liest
'                   sie danach neu ein
'14.11.2017 Fehlerkorrektur
'           Zustand: Spielart=Lorum: Bei Klick auf die bewegte Karte beginnt sie ihren Weg erneut oder setzt ihren Weg über die sonstige
'                   Strecke hinaus fort oder läuft sogar rückwärts und geht dann in eine Schleife
'           Lösung: blnLorumLäuft verhindert die Klick-Wiederholung
'18.11.2017 Zustand: Das Beenden über das Schließkreuz funktioniert nur selten
'           Lösung: Versuch mit Call term_global - bringt nichts
'----------------------------------------------------------------------------------------------------------------------------
'Version 12
'26.11.2017 kosmetische Verbesserung
'           Zustand: der Kartenstapel von Mitte und Spieler ist nicht zentriert
'           Lösung: Wer richtig rechnen kann ist im Vorteil. MitteStapelLeft  und SpielerStapelLeft war falsch ausgerechnet.
'27.11.2017 kosmetische Verbesserung
'           Zustand: Wenn bei Spielart <> Lorum die letzte Karte bewegt wird, kann man solange wie die Bewegung anhält, beide Karten
'                   sehen. Die zugedeckte letzte und die bewegte letzte Karte
'           Lösung: Sobald die Bewegung beginnt, wird cdLinks(MyIndex).Visible = False - ebenso cdMitte und cdRechts
...
'           Lösung: Reihenfolge vertauschen
'                   hinterste Entladen
'                   Spielerkarten NeuAuflegen
'                   Spielerkarte bewegen
...
'           Lösung: 'Function VorbehandlungOber' soll nur nach Ass oder König suchen
'28.11.2017 Verbesserung der Intelligenz
'           'Function VorbehandlungRoterKönig' soll den König ignorieren bei der Suche nach der höchsten Karte
'29.11.2017 Fehlerkorrektur
'           Zustand: Bei Spielwiederholung mit Strg+N sind manche Schalter nicht zurückgestellt
'           Lösung: blnAlleOberGespielt=False blnRKGespielt=False blnAlleRotenGespielt=False
'08.12.2017 Verbesserung der Intelligenz
'           Zustand: Spielart=RoterKönig - Rechts ist Ausspieler und spielt RotAcht, Spieler spielt RotAss, links hat den RoterKönig,
'                   aber spielt statt dessen die RotZehn, obwohl RotAss auf dem Tisch liegt
'           Lösung: Ich brauche noch einen Schalter blnRotAssAufDemTisch
'09.12.2017 kosmetische Verbesserung
'           Zustand: Es ist wünschenswert am Ende von Spielart=Lorum nach der letzten Msgbox, die mit Enter-Taste beantwortet wird,
'                   auch noch mit der Enter-Taste das Spiel zu beenden, anstelle auf die Form klicken zu müssen
'           Lösung: Ein Drücken der Enter-Taste wird weitergeleitet zu Form_Click
'10.12.2017 Verbesserung
'           Zustand: Manchmal wäre es zum Fehlerfinden gut, wenn ich in die Kartenverteilung eingreifen könnte
'           Anstelle von Mischen teile ich die Karten in fester Reihenfolge aus
'           Lösung: In Prozedur NichtMischen ist eine feste Reihenfolge vorgegeben
'                   gblnNichtMischen = True setzen, wenn Prozedur NichtMischen aufgerufen werden soll
'17.12.2017 Fehlerkorrektur
'           Zustand: Spielart=LorumMitte hat soeben GrünOber gespielt, es ist eine MsgBox offen. Bei Drücken der Enter-Taste(oder Klick auf OK)
'                   wird immer wieder der GrünOber gespielt
'           Lösung: Der GrünOber wird immer wieder gespielt, obwohl er .GespieltVon = 9 hätte sein müssen, war es aber nicht
'                   EntladenLorum muss geändert werden; Aufrufparameter gespielteKarte entfällt
'                   ich suche bis ich die gespielteKarte gefunden habe, die mit LorumAuflegeFarbe und LorumStartWert übereinstimmt
'                   LorumAssAblegen muss geändert werden
'                   LorumAbwärtsAblegen muss geändert werden
'19.12.2017 Verbesserung
'           Zustand: Günter Greif meckert: Wenn schon ein Abbrechen nach 1 oder 2 oder 3 Durchgängen angeboten wird, sollte auch ein
'                   Wiedereinsetzen am Abbruchpunkt möglich sein
'           Lösung: Abbrechen nach 1 oder 2 oder 3 Durchgängen wird nicht mehr angeboten. Stattdessen bringe ich die geänderte MsgBox
'                   "Die nächste Spielrunde beginnt.
'                   "Du mußt zum Weiterspielen auf den roten Buchstaben klicken"
'19.12.2017 Verbesserung
'           Zustand: Das Beenden über das Schließkreuz funktioniert nur selten
'           Lösung: Schuld ist 'cancel = true' in frmSpielBogen
'                   frmSpielBogen wird überhaupt nicht mehr entladen(es gibt kein Schließkreuz), höchstens Me.Hide
'19.12.2017 Verbesserung
'           Zustand: Es scheint so als ob häufig dieselben Karten verteilt würden. Besonders nach Start -> Beenden -> neuer Start
'           Lösung: Anstelle von Randomize Timer -> Randomize
'19.12.2017 Fehlerkorrektur Nachbesserung zu 08.12.2017 '08.12.2017 19.12.2017
'           Zustand: Spielart=RoterKönig bringt Laufzeitfehler '9' Index außerhalb...
'           Lösung: falsch ist ...Gespielt.CardType = AKType
'                   richtig ist ...Gespielt.CardType = 2
'18.01.2018 Verbesserung
'           Zustand: Die Änderung der Schriftgröße wirkt erst nach Schließen von frmFontSize
'           Lösung: Sofort nach Klick auf klein/mittel/groß ist die Schriftgrößenänderung sichtbar
'
'----------------------------------------------------------------------------------------------------------------------------
'Version 13
'16.02.2018 Verbesserung mit Multi Monitor
'           Zustand: Günter meckert, dass es schon mal besser ging
...
'           Lösung: frmMsgBox kommt jetzt auf dem Zweitmonitor
...
'           Begleiterscheinung:
'                   MsgBox 'falsch gespielt bei Rot' oder 'Du musst Farbe zugeben' kommt über der betreffenden Karte.
...
'           Es gibt ein Menü Spielregeln
'19.03.2018 Verbesserung
'           Das Gerbing-Icon wird durch ein Roserl.ico ersetzt
'----------------------------------------------------------------------------------------------------------------------------
'Version 14
'17.03.2018 Verbesserung Günter Greif
'           Mit dem Menü 'Beenden' wird Roserl beendet und gleichzeitig wird der Spielstand in die Binärdatei roserl.bin gespeichert.
'           Das sind keine Zwischenspielstände, sondern der Spielstand nach jeweils einer Roserl-Runde(=6 Spiele).
'           Wenn während der ersten Runde abgebrochen wird(da gibt es noch kein Runden-Ergebnis), beginnt also Roserl neu
...
'----------------------------------------------------------------------------------------------------------------------------
'Version 15
'13.06.2018 Verbesserung Günter Greif
...
'           Es bleibt aber dabei, dass nur Spielstände nach vollen Runden gespeichert werden
'           Das Gerbing-Icon wird in sämtlichen Formularen durch ein Roserl48Sieben.ico ersetzt
'10.10.2018 Verbesserung
'           Zustand: Im Windows 10 kommt Roserl verlangt eine Bildschirmauflösung von mindestens 1920x1060
'           Lösung: Ich ergänze:gefunden sreenwidth=xxxx screenheight=yyyy
'                   Ich erhalte:
'                   Roserl verlangt eine Bildschirmauflösung von mindestens 1920x1060
...
'           Gegenmaßnahme: Eigenschaften der exe öffnen -> Kompatibilität -> Hohe DPI-Einstellungen ändern -> Hohe DPI Skalierung überschreiben
'                   -> Skalierung wird durchgeführt von -> Anwendung
'----------------------------------------------------------------------------------------------------------------------------
'20.03.2020 Verbesserung
'           Zustand: Es gibt Beschwerden, dass angeblich zu oft die gleichen Karten verteilt werden(Günter Greif)
'           Lösung: Es wird nur einmal zu Programmbeginn Randomize gemacht
'----------------------------------------------------------------------------------------------------------------------------
'Version 15.0.1
'26.07.2020 Verbesserung
'           Zustand: Manchmal ärgert mich meine blöde Spielweise, wenn ich ein Spiel schlecht beendet habe. Dann würde ich gern
'                   die Chance erhalten das selbe Spiel noch einmal zu spielen, ohne dass mein schlechtes Spiel angerechnet wird.
'           Lösung: Ich muss die bisherige Lösung Strg+N anpassen
...
'           Zustand: Bei Eingabe von 'maloi' decken die Mitspieler ihre Karten auf. Bisher sind diese unsortiert und somit unübersichtlich.
'                   Ich will sortierte Darstellung.
'           Lösung: Die Prozeduren LinksKartenNeu, MitteKartenNeu, RechtsKartenNeu werden neu geschrieben
'           --aber--
...
'           Facemode = NachOben ändere in FaceMode = Rückseite
'----------------------------------------------------------------------------------------------------------------------------
'Version 15.0.1
...
'           Lösung: Programmierfehler es wurde mit cdSpieler.Count gerechnet anstelle von
'                   cdMitte.Count
'----------------------------------------------------------------------------------------------------------------------------
'Version 15.0.2
'19.05.2021 Nachbesserung zum 26.07.2020
'           Zustand: Seit ich ein schlechtes Spiel wiederholen kann, gewinne ich fast alle Spiele. Das macht eigentlich keinen Spaß.
'                   Ich will eine Variante wo der Button 'Spiel wiederholen' sichtbar ist und eine wo der Button nicht sichtbar ist.
'           Lösung:     #If Spielwiederholen = 0 Then                   '0=nein
'                           btnSpielWiederholen.Visible = False
'                       #Else
'                           btnSpielWiederholen.Visible = True
'                       #End If
'                   Projekt -> Eigenschaften von Roserl -> Erstellen -> Argumente für bedingte Kompilierung -> Spielwiederholen = 0
'                       heißt ohne den Button 'Spiel wiederholen' erzeugt die RoserlO.exe
'                   Projekt -> Eigenschaften von Roserl -> Erstellen -> Argumente für bedingte Kompilierung -> Spielwiederholen = 1
'                       heißt mit Button 'Spiel wiederholen' erzeugt die RoserlM.exe
'                   -----------------------------------------------------------------------
...
'
'Probleme
'20.09.2017 Beim ersten frmRoserl_Resize rückt die Form zu weit nach oben. Ich finde keine Gegenmaßnahme übers Programm, aber es hilft
'           einfach am Rand zu ziehen.
'20.09.2017 bei Günter Greif: Roserl wird beendet und beim Neustart kommt:
'           MsgBox "Roserl verlangt eine Bildschirmauflösung von mindestens 1920x1060." ist ganz oben links in der Ecke
'           und von frmRoserl ist nichts zu sehen. Das Hintergrundbild ist zu sehen.
'           Günter benutzt ein MultiMonitor-System.
'           User an- und abmelden hilft. Dann geht's normal weiter.
'           Ich kann es nicht reproduzieren.
'19.01.2018 Die Bestwerte werden erst eingetragen, nachdem nach der 4.Runde weiterspielen gewählt wurde und nachdem der erste Stich Rot
'           ausgespielt wurde.
'           Ich kann es nicht reproduzieren.
'17.03.2018 Roserl.pdb wird erzeugt durch Compilieren mit Häkchen bei 'Debug-Informationen für symbolischen Debugger generieren'
'           Bei ungeklärten Laufzeitfehlern, die nur in der exe passieren, kann man dann mit dem C++ Debugger weitere Informationen bekommen
    ...
    Dim blnMoveLäuft As Boolean
    Dim blnRKGespielt As Boolean                    'RoterKönigGespielt
    ...
    Dim blnGrünZEM As Boolean                       'Grün Zum Ersten Mal
    Dim blnEichelZEM As Boolean                     'Eichel Zum Ersten Mal
    Dim blnStapelBBenutzen As Boolean
    Dim AufrufzählerSpieler As Integer                                  'Gerbing 09.11.2017
    Dim AufrufzählerLinks As Integer                                    'Gerbing 09.11.2017
    Dim AufrufzählerMitte As Integer                                    'Gerbing 09.11.2017
    Dim AufrufzählerRechts As Integer                                   'Gerbing 09.11.2017
    Dim AufrufzählerEinsammler As Integer                               'Gerbing 09.11.2017
    Dim AufrufzählerLorum As Integer                                    'Gerbing 09.11.2017
    Dim LorumPosition As Integer                                        'Gerbing 09.11.2017
    Dim blnlorumläuft As Boolean                                        'Gerbing 14.11.2017
    
    Dim LorumStartWert As Integer
    Dim LorumStartPosition As Integer
    Dim LorumAuflegeFarbe As Integer
    Dim LorumAufgelegtZähler As Integer
...
'    screenHeight = GetDeviceCaps(Me.hdc, VERTRES)
    ...
    If screenWidth < 1920 Or screenHeight < 1060 Then
        ...
        gstrMsg = "Roserl verlangt eine Bildschirmauflösung von mindestens 1920x1060." & vbNewLine
...
Private Sub WelchenAblegestapelBenutzen(LorumAuflegeFarbe As Integer)
    ...
    If cdRoserlGrünA.Count >= 5 And LorumAuflegeFarbe = 3 Then blnStapelBBenutzen = True
    If cdRoserlEichelA.Count >= 5 And LorumAuflegeFarbe = 4 Then blnStapelBBenutzen = True
    'wenn die höchste Karte ein Ass ist
    ...
    End If
    If cdRoserlGrünA(0).Visible = True Then
        If cdRoserlGrünA(cdRoserlGrünA.Count - 2).CardValue = 8 And LorumAuflegeFarbe = 3 Then blnStapelBBenutzen = True
    End If
    ...
    End If
    'wenn zB die höchste Karte von SchellA und die niedrigste Karte von SchellAss aufeinander folgen
    ...
    End If
    If cdRoserlGrünAss(0).Visible = True And cdRoserlGrünA(0).Visible = True Then
        If cdRoserlGrünA(cdRoserlGrünA.Count - 2).CardValue = cdRoserlGrünAss(cdRoserlGrünAss.Count - 1).CardValue - 1 And LorumAuflegeFarbe = 3 Then blnStapelBBenutzen = True
    End If
...
Private Sub cdLinks_Click(Index As Integer)
    ...
    If Spielart = Lorum Then
        If blnlorumläuft Then Exit Sub                                      'Gerbing 14.11.2017
        If PlayerTurnRoserl = Links Then
            blnlorumläuft = True                                            'Gerbing 14.11.2017
            PlayerTurn = Links
            'Untersuche an welchen Schell Rot Grün Eichel Stapel an oder abgelegt werden soll
            ...
            blnlorumläuft = False                                           'Gerbing 14.11.2017
        End If
    End If
End Sub
...
Private Sub cdSpieler_Click(Index As Integer)
    ...
    If Spielart = Lorum Then
        ...
        If PlayerTurnRoserl = Spieler Then
            blnlorumläuft = True                                            'Gerbing 14.11.2017
            PlayerTurn = Spieler
            'Untersuche an welchen Schell Rot Grün Eichel Stapel diese Karte an oder abgelegt werden kann, StapelA oder StapelB
            LorumAuflegeFarbe = cdSpieler(Index).CardType
            Call WelchenAblegestapelBenutzen(LorumAuflegeFarbe)
            LorumStartWert = cdSpieler(Index).CardValue
            LorumStartPosition = Index + 1
            LorumAufgelegtZähler = 1
            ...
            LorumStartPosition = Index + 1
            LorumAufgelegtZähler = 1
            'wenn der Spieler eine mögliche Abwärts-Anlegekarte ausspielt
            If cdSpieler(Index).CardValue < 8 Then                                     '<8=unter dem Ass
                rc = LorumAbwärtsAblegen()
                If rc <> 0 Then
                    'Abwärtskarte gefunden
                    blnlorumläuft = False                                       'Gerbing 14.11.2017
                    Exit Sub
                Else
                    'Abwärtskarte nicht gefunden
'                    gblnMsgBoxAntwort = True
'                    gstrMsg = "Diese Karte ist keine Abwärts-Karte, willst Du sie einzeln ablegen?"
'                    frmMsgBox.Show 1
...
'                    End If
    ...
    If IsPlayable(Index) = True Then
        ...
        If Ausspieler = Rechts Then
            'Links und Mitte müssen noch ausspielen
            Call LinksPlay
            Call MittePlay
        End If
        If Ausspieler = Spieler Then
            'Links und Mitte und Rechts müssen noch ausspielen
            Call LinksPlay
            Call MittePlay
            Call RechtsPlay
        End If
...
Private Sub Form_Click()
    ...
    'Prozedur Einsammeln speichert wer den Stich eingenommen hat und ermittelt wer als Nächster ausspielen muss,
    '   das können sein LinksPlay MittePlay RechtsPlay oder der Spieler
    'Prozedur LinksPlay MittePlay oder RechtsPlay bestimmt, welche Karte als nächste ausgespielt werden kann oder muss
    'Wenn der Spieler ausspielen muss, warten dass dieser auf eine Karte klickt
    Dim I As Integer
    
    On Error Resume Next
    On Error GoTo 0
    If blnMoveLäuft = True Then Exit Sub
    ...
    If blnSpielerWarDran = True And blnLinksWarDran = True And blnMitteWarDran = True And blnLinksWarDran = True Then
        ...
        If blnRKGespielt = True Then
            blnRKGespielt = False
            Call Spielende
            'MsgBox "Der rote König ist gespielt, damit endet das Spiel"
            Exit Sub
        End If
...
Private Sub EntladenLorum(PlayerTurn As Players)
    ...
    'ich die gespielteKarte gefunden habe, die mit LorumAuflegeFarbe und LorumStartWert übereinstimmt
    'zähle die mit Kennzeichen .GespieltVon=9
...
Private Sub EineKarteAblegen(GKType As Integer, GKValue As Integer)
    'Prozedur EineKarteAblegen macht die Bewegungsanimation und merkt sich die ausgespielte Karte für die Stichauswertung(Einsammeln)
...
Private Function IsPlayable(Index As Integer) As Boolean
    ...
    'Kontrollieren ob der Spieler diese Karte spielen darf, abhängig vom gerade gewählte Spiel
    'bei Rot dürfen die ersten zwei Karten keine roten Karten sein und es dürfen keine roten Karten abgeworfen werden
    'ob der Spieler die geforderte Farbe hat oder ob er fälschlicherweise eine Karte abwerfen will
...
Dim I As Integer
    ...
    Next I
    For I = cdRoserlGrünA.Count To 1 Step -1
        Unload cdRoserlGrünA.Item(I)
    Next I
    For I = cdRoserlGrünB.Count To 1 Step -1
        Unload cdRoserlGrünB.Item(I)
    Next I
    ...
    Next I
    For I = cdRoserlGrünAss.Count To 1 Step -1
        Unload cdRoserlGrünAss.Item(I)
    Next I
    ...
    cdRoserlGrünA(0).Visible = False
    cdRoserlGrünB(0).Visible = False
    ...
    cdRoserlGrünAss(0).Visible = False
...
Sub MitteKartenNeu()                                    'Gerbing 28.07.2020
    ...
    Dim n As Integer
    Dim m As Integer
    Dim HöchsteFarbe As Integer
    Dim HöchsterWert As Integer
            ...
            For n = 1 To UBound(MitteCards)
                If MitteCards(n).cGespieltVon <> 9 Then
                    If Rangliste(n).Vergeben = False Then
                        If MitteCards(n).cType > HöchsteFarbe Then
                            HöchsteFarbe = MitteCards(n).cType
                            HöchsterWert = MitteCards(n).cValue
                        Else
                            If MitteCards(n).cType = HöchsteFarbe Then
                                If MitteCards(n).cValue >= HöchsterWert Then
                                    HöchsterWert = MitteCards(n).cValue
                                End If
                            End If
                        End If
                ...
                End If
            Next n
            'Die Mittecards(m), die HöchsteFarbe und HöchsterWert enthält bekommt Rangliste(m).RangPosition = a und Rangliste(m).Vergeben = True
            For m = 1 To UBound(MitteCards)
                If MitteCards(m).cGespieltVon <> 9 Then
                    If Rangliste(m).Vergeben = False Then
                        If MitteCards(m).cType = HöchsteFarbe And MitteCards(m).cValue = HöchsterWert Then
...
Sub SpielerKartenNeu()
        ...
        For I = 1 To UBound(SpielerCards)
            ...
            For n = 1 To UBound(SpielerCards)
                If SpielerCards(n).cGespieltVon <> 9 Then
                    If Rangliste(n).Vergeben = False Then
                        If SpielerCards(n).cType > HöchsteFarbe Then
                            HöchsteFarbe = SpielerCards(n).cType
                            HöchsterWert = SpielerCards(n).cValue
                        Else
                            If SpielerCards(n).cType = HöchsteFarbe Then
                                If SpielerCards(n).cValue >= HöchsterWert Then
                                    HöchsterWert = SpielerCards(n).cValue
                                End If
                            End If
                        End If
                ...
                End If
            Next n
            'Die Spielercards(m), die HöchsteFarbe und HöchsterWert enthält bekommt Rangliste(m).RangPosition = a und Rangliste(m).Vergeben = True
            For m = 1 To UBound(SpielerCards)
                If SpielerCards(m).cGespieltVon <> 9 Then
                    If Rangliste(m).Vergeben = False Then
                        If SpielerCards(m).cType = HöchsteFarbe And SpielerCards(m).cValue = HöchsterWert Then
                            Rangliste(m).RangPosition = a
                            Rangliste(m).Vergeben = True
                        End If
                    End If
    ...
    For I = 0 To cdSpieler.Count
        On Error Resume Next
        cdSpieler(I).Visible = False
        cdSpieler(I).FaceMode = Rückseite
        On Error GoTo 0
    Next I
    n = 0
    p = 0
...
Sub LinksKartenNeu()
        ...
        For I = 1 To UBound(LinksCards)
            ...
            For n = 1 To UBound(LinksCards)
                If LinksCards(n).cGespieltVon <> 9 Then
                    If Rangliste(n).Vergeben = False Then
                        If LinksCards(n).cType > HöchsteFarbe Then
                            HöchsteFarbe = LinksCards(n).cType
                            HöchsterWert = LinksCards(n).cValue
                        Else
                            If LinksCards(n).cType = HöchsteFarbe Then
                                If LinksCards(n).cValue >= HöchsterWert Then
                                    HöchsterWert = LinksCards(n).cValue
                                End If
                            End If
                        End If
                ...
                End If
            Next n
            'Die Linkscards(m), die HöchsteFarbe und HöchsterWert enthält bekommt Rangliste(m).RangPosition = a und Rangliste(m).Vergeben = True
            For m = 1 To UBound(LinksCards)
                If LinksCards(m).cGespieltVon <> 9 Then
                    If Rangliste(m).Vergeben = False Then
                        If LinksCards(m).cType = HöchsteFarbe And LinksCards(m).cValue = HöchsterWert Then
                            Rangliste(m).RangPosition = a
                            Rangliste(m).Vergeben = True
                        End If
                    End If
    ...
    For p = 1 To UBound(LinksCards)
        ...
        For I = 1 To UBound(LinksCards)
            ...
            End If
        Next I
        Rangliste(n).RangPosition = 9                                           '9 ist das Kennzeichen für schon gefunden
        On Error Resume Next
        If blnMaloiGetippt = True Then
            cdLinks(p - 1).FaceMode = NachOben
        Else
            cdLinks(p - 1).FaceMode = Rückseite
        End If
        '-----------------------------------
...
Sub RechtsKartenNeu()
        ...
        For I = 1 To UBound(RechtsCards)
            ...
            For n = 1 To UBound(RechtsCards)
                If RechtsCards(n).cGespieltVon <> 9 Then
                    If Rangliste(n).Vergeben = False Then
                        If RechtsCards(n).cType > HöchsteFarbe Then
                            HöchsteFarbe = RechtsCards(n).cType
                            HöchsterWert = RechtsCards(n).cValue
                        Else
                            If RechtsCards(n).cType = HöchsteFarbe Then
                                If RechtsCards(n).cValue >= HöchsterWert Then
                                    HöchsterWert = RechtsCards(n).cValue
                                End If
                            End If
                        End If
                ...
                End If
            Next n
            'Die rechtscards(m), die HöchsteFarbe und HöchsterWert enthält bekommt Rangliste(m).RangPosition = a und Rangliste(m).Vergeben = True
            For m = 1 To UBound(RechtsCards)
                If RechtsCards(m).cGespieltVon <> 9 Then
                    If Rangliste(m).Vergeben = False Then
                        If RechtsCards(m).cType = HöchsteFarbe And RechtsCards(m).cValue = HöchsterWert Then
                            Rangliste(m).RangPosition = a
                            Rangliste(m).Vergeben = True
                        End If
                    End If
    ...
    For p = 1 To UBound(RechtsCards)
        ...
        Else
            cdRechts(p - 1).FaceMode = Rückseite
        End If
        '-----------------------------------
    ...
    Select Case KeyCode
        ...
        Case vbKeyN
            If CtrlDown Then                               'Strg+N gleichzeitig
                ...
                gstrMsg = gstrMsg & "Willst Du sofort das neue Spiel beginnen, wähle Ja" & vbNewLine
                gstrMsg = gstrMsg & "Willst Du das aktuelle Spiel erst noch zu Ende spielen, wähle Nein"
                frmMsgBox.Show 1
                If glngAntwort = vbYes Then
...
Private Sub Einsammeln()
    ...
    Dim HöchsteKarte As Integer
    Dim I As Integer

    'Einsammeln kann nur ein Mitspieler, der eine höhere Karte der gleichen Farbe gespielt hat als der Ausspieler
    'Wenn kein Mitspieler die gleiche Farbe gespielt hat (also abgeworfen) dann ist der Ausspieler der Einsammler
    'Nach dem Einsammeln steht fest, wer als nächster ausspielen muss
    ...
    If Ausspieler = Rechts Then
        ...
        HöchsteKarte = RechtsGespielt.CardValue
        If SpielerGespielt.CardType = RechtsGespielt.CardType And SpielerGespielt.CardValue > HöchsteKarte Then
            HöchsteKarte = SpielerGespielt.CardValue
            Einsammler = Spieler
        End If
        If LinksGespielt.CardType = RechtsGespielt.CardType And LinksGespielt.CardValue > HöchsteKarte Then
            HöchsteKarte = LinksGespielt.CardValue
            Einsammler = Links
        End If
        If MitteGespielt.CardType = RechtsGespielt.CardType And MitteGespielt.CardValue > HöchsteKarte Then
            HöchsteKarte = MitteGespielt.CardValue
            Einsammler = Mitte
        End If
    End If
    If Ausspieler = Spieler Then
        ...
        HöchsteKarte = SpielerGespielt.CardValue
        If LinksGespielt.CardType = SpielerGespielt.CardType And LinksGespielt.CardValue > HöchsteKarte Then
            HöchsteKarte = LinksGespielt.CardValue
            Einsammler = Links
        End If
        If MitteGespielt.CardType = SpielerGespielt.CardType And MitteGespielt.CardValue > HöchsteKarte Then
            HöchsteKarte = MitteGespielt.CardValue
            Einsammler = Mitte
        End If
        If RechtsGespielt.CardType = SpielerGespielt.CardType And RechtsGespielt.CardValue > HöchsteKarte Then
            HöchsteKarte = RechtsGespielt.CardValue
            Einsammler = Rechts
        End If
    End If
    If Ausspieler = Links Then
        ...
        HöchsteKarte = LinksGespielt.CardValue
        If MitteGespielt.CardType = LinksGespielt.CardType And MitteGespielt.CardValue > HöchsteKarte Then
            HöchsteKarte = MitteGespielt.CardValue
            Einsammler = Mitte
        End If
        If RechtsGespielt.CardType = LinksGespielt.CardType And RechtsGespielt.CardValue > HöchsteKarte Then
            HöchsteKarte = RechtsGespielt.CardValue
            Einsammler = Rechts
        End If
        If SpielerGespielt.CardType = LinksGespielt.CardType And SpielerGespielt.CardValue > HöchsteKarte Then
            HöchsteKarte = SpielerGespielt.CardValue
            Einsammler = Spieler
        End If
    End If
    If Ausspieler = Mitte Then
        ...
        HöchsteKarte = MitteGespielt.CardValue
        If RechtsGespielt.CardType = MitteGespielt.CardType And RechtsGespielt.CardValue > HöchsteKarte Then
            HöchsteKarte = RechtsGespielt.CardValue
            Einsammler = Rechts
        End If
        If SpielerGespielt.CardType = MitteGespielt.CardType And SpielerGespielt.CardValue > HöchsteKarte Then
            HöchsteKarte = SpielerGespielt.CardValue
            Einsammler = Spieler
        End If
        If LinksGespielt.CardType = MitteGespielt.CardType And LinksGespielt.CardValue > HöchsteKarte Then
            HöchsteKarte = LinksGespielt.CardValue
            Einsammler = Links
        End If
    End If
    '--------------------------------------------------------------------------------------------------------
    'kennzeichnen wer die Karten eingesammelt hat und Kontrolle ob alle Ober, alle Roten, RoterKönig ausgespielt sind
    blnRKGespielt = False
    For I = AKIndex - 3 To AKIndex
        AusgespielteKarten(I).cEingesammeltVon = Einsammler     'Kennzeichnen wer die Karten eingesammelt hat
        If AusgespielteKarten(I).cType = 2 And AusgespielteKarten(I).cValue = 7 And Spielart = RoterKönig Then
            blnRKGespielt = True                                'Roter König gespielt
        End If
        If AusgespielteKarten(I).cValue = 6 And Spielart = Ober Then    'Gerbing 12.09.2017
            ZählerOber = ZählerOber + 1
            If ZählerOber = 4 Then
                blnAlleOberGespielt = True
            End If
        End If
        If AusgespielteKarten(I).cType = 2 And Spielart = Rot Then      'Gerbing 12.09.2017
            ZählerRote = ZählerRote + 1
            If ZählerRote = 8 Then
    ...
    Select Case Einsammler
        Case 0
            ...
            lblLinks.ForeColor = &HFFFFFF                       'weiß
        ...
        Case 1
            ...
            lblSpieler.ForeColor = &HFFFFFF                     'weiß
            lblMitte.ForeColor = &HFFFFFF
            lblRechts.ForeColor = &HFFFFFF
            lblMitte.Font.Bold = False
            lblRechts.Font.Bold = False
...
Private Sub Spielende()
    ...
    'Soll das Spiel wiederholt werden weil Strg+N gedrückt wurde?
    ...
    'das Spiel ist zu Ende
    Call PunkteZählen
    'Soll das Spiel wiederholt werden weil Button 'Spiel wiederholen in frmSpielEnde gedrückt wurde? Gerbing 26.07.2020
    If blnSpielWiederholen = True Then
        gstrMsg = "Das Spiel wird wiederholt"
        frmMsgBox.Show 1
        Call Kartengeben
    ...
    If Spielart <> Lorum Then
        ...
        frmRoserl.lblRoserl(Spielart).BackColor = &H8000000F                'Farbe zurücksetzen
        Spielart = Spielart + 1                                             'nächste Spielart
        frmRoserl.lblRoserl(Spielart).BackColor = &HFF&                     'Buchstabe für das nächste Spiel wird rot
        If Spielart = Lorum Then                                            'wird das nächste Spiel=Lorum ?
            ' das nächste Spiel wird Lorum
...
'            frmMsgBox.Show 1
    ...
    Else
        ...
        Call Spielabrechnung
        If Rundezähler <> 4 Then
'            gblnMsgBoxAntwort = True
'            gstrMsg = "Es wird viermal gespielt, willst Du weiter spielen?"
'            gstrMsg = "Die nächste Spielrunde beginnt"
'            frmMsgBox.Show 1
'            If glngAntwort = vbNo Then
'                AlleKartenEntladen
'                Unload Me
'                End
'            End If
            'Rundezähler erhöhen                                        'Gerbing 18.09.2017
            If Rundezähler = 1 Then
                lblRunde.Caption = "2. Runde"
            ElseIf Rundezähler = 2 Then
                lblRunde.Caption = "3. Runde"
            ElseIf Rundezähler = 3 Then
                lblRunde.Caption = "4. Runde"
            End If
            Rundezähler = Rundezähler + 1
        Else
            'Rundezähler = 4
            ...
            If glngAntwort = vbNo Then
                ...
                End
            Else
                Rundezähler = 1                                         'Gerbing 17.08.2017
                lblRunde.Caption = "1. Runde"                       'Gerbing 28.09.2017
                'Spielbogen muss auf Null zurückgesetzt werden              'Gerbing 03.09.2017
                Call SpielBogenNull
            End If
        End If
        'AusspielerBeiSpielbeginn um eins zurücksetzen damit jeder einmal bei jedem Spiel der Ausspieler ist
    ...
    If Spielart = Rot Then                                                  'Gerbing 14.10.2017
        gstrMsg = "Die nächste Spielrunde beginnt." & vbNewLine             'Gerbing 19.12.2017
...
Private Function SucheBesteKarte() As Integer
    ...
    If Ausspieler = PlayerTurn Then
        ...
        If Spielart = Rot And AKIndex < 8 Then                      'Gerbing 14.10.2017
            ...
            'Durchsuche alle Karten außer rote bei den ersten zwei Stichen und finde die niedrigste Zum Ausspielen
            ...
            If Ausspieler = Links Then
                ...
                ElseIf LinksCards(SucheBesteKarte).cType = 2 Then     '2=Rot
                    blnRotZEM = False
                ElseIf LinksCards(SucheBesteKarte).cType = 3 Then     '3=Grün
                    blnGrünZEM = False
            ...
            ElseIf Ausspieler = Mitte Then
                ...
                ElseIf MitteCards(SucheBesteKarte).cType = 2 Then     '2=Rot
                    blnRotZEM = False
                ElseIf MitteCards(SucheBesteKarte).cType = 3 Then     '3=Grün
                    blnGrünZEM = False
            ...
            ElseIf Ausspieler = Rechts Then
                ...
                ElseIf RechtsCards(SucheBesteKarte).cType = 2 Then     '2=Rot
                    blnRotZEM = False
                ElseIf RechtsCards(SucheBesteKarte).cType = 3 Then     '3=Grün
                    blnGrünZEM = False
        ...
        End If
        '---------------------------------------------------------------------------------------------------
        If Spielart = RoterKönig Then
            'nach dem Ausspielen von RoterKönig kann das Spiel beendet werden
            'auf keinen Fall den roten König ausspielen, wenn es noch andere rote Karten gibt
            SucheBesteKarte = SucheBesteKarteRoterKönigAusspieler
            Exit Function
        End If
        '---------------------------------------------------------------------------------------------------
        If Spielart = Lorum Then
    ...
    Else
        ...
        '---------------------------------------------------------------------------------------------------
        If Spielart = RoterKönig Then
            'Wenn abgeworfen werden kann, zuerst RoterKönig abwerfen,
            'wenn zugegeben werden muss und es ist eine höhere Karte gespielt als RoterKönig, dann RoterKönig zugeben
            'wenn zugegeben werden muss und es ist eine niedrigere Karte gespielt als RoterKönig, RoterKönig nur wenn er der letzte von Rot ist
            SucheBesteKarte = SucheBesteKarteRoterKönigMitspieler
            Exit Function
        End If
        '---------------------------------------------------------------------------------------------------
        If Spielart = Lorum Then
...
Private Function SucheBesteKarteRotOderSticheAusspieler()
    ...
    'Durchsuche alle Karten außer rote bei den ersten zwei Stichen und finde die niedrigste zum Ausspielen
    'Gerbing 11.07.2017 Intelligenz-Verbesserung bei Spielart=Rot bei den ersten zwei Stichen die höchste Nicht-Rot ausspielen
    ...
    Dim NiedrigstePosition As Integer
    Dim HöchsterWert As Integer
    Dim HöchstePosition As Integer
    ...
    If PlayerTurn = Links Then
        ...
        Else
            'es ist Spielart=Rot
            HöchsterWert = 0                                            'Gerbing 11.07.2017
            n = 0
            For I = 1 To UBound(LinksCards)
                If LinksCards(I).cType <> 2 Then                        '2=Rot
                    'es ist keine Rot-Karte
                    If LinksCards(I).cValue >= HöchsterWert Then
                        HöchsterWert = LinksCards(I).cValue
                        HöchstePosition = I
                    End If
                Else
                ...
                End If
            Next I
            SucheBesteKarteRotOderSticheAusspieler = HöchstePosition
            Exit Function
        End If
    End If
    '----------------------------
    If PlayerTurn = Mitte Then
        ...
        Else
            ...
            For I = 1 To UBound(MitteCards)
                If MitteCards(I).cType <> 2 Then                        '2=Rot
                    'es ist keine Rot-Karte
                    If MitteCards(I).cValue >= HöchsterWert Then
                        HöchsterWert = MitteCards(I).cValue
                        HöchstePosition = I
                    End If
                Else
    ...
    If PlayerTurn = Rechts Then
        ...
        Else
            ...
            For I = 1 To UBound(RechtsCards)
                If RechtsCards(I).cType <> 2 Then                        '2=Rot
                    'es ist keine Rot-Karte
                    If RechtsCards(I).cValue >= HöchsterWert Then
                        HöchsterWert = RechtsCards(I).cValue
                        HöchstePosition = I
                    End If
                Else
...
Private Function SucheBesteKarteRotOderSticheMitspieler()
    ...
    'Bei den ersten zwei Stichen darf nicht Rot abgeworfen werden und es muss die höchste abgeworfen werden
    'Bei den ersten zwei Stichen bei spielart = Rot kann die höchste Karte zugegeben werden Gerbing 09.07.2017
    'Ab 3.Stich ist vorrangig Rot abzuwerfen Gerbing 13.10.2017
    'Wenn eine Farbe zum erstenmal gespielt wird, ist zu prüfen, ob der Computer von einer Farbe eine hohe und eine niedrige Karte hat.
    'Es ist in diesem Fall besser zuerst die hohe Karte zuzugeben
    '       dazu dient NachbehandlungMitspieler
    'Anstelle von DieHöchsteAbwerfen ist es manchmal besser DieEinzigeAbwerfen(wenn es nicht gerade die Sieben ist)
    '       dazu dient NachbehandlungAbwerfen
    'Wenn ich der 4.Zugeber(der letzte eines Stiches) bin, muss ich versuchen
    'geradeso unterhalb der höchsten Karte zu bleiben, die auf dem Tisch liegt, nicht einfach die niedrigste
    ...
    If PlayerTurn = Links Then
        ...
        If blnFarbeVorhanden = False Then
            ...
            If AKIndex < 8 Then                                             'Die ersten zwei Stiche
                ...
                'Suche die höchste aber nicht Rot
                HöchsterWert = 0
                For I = 1 To UBound(LinksCards)
                    If LinksCards(I).cType <> 2 Then                        '2=Rot
                        If LinksCards(I).cValue >= HöchsterWert Then
                    ...
                    End If
                Next I
                SucheBesteKarteRotOderSticheMitspieler = NachbehandlungAbwerfen(LinksCards, HöchstePosition)
                Exit Function
            Else
                'es ist der dritte oder weitere Stich
                'Bei Rot vorrangig höchste Rot abwerfen                     'Gerbing 13.10.2017
                If Spielart = Rot Then
                    HöchsterWert = 0
                    For I = 1 To UBound(LinksCards)
                        If LinksCards(I).cValue >= HöchsterWert And LinksCards(I).cType = 2 Then '2=Rot
                            HöchsterWert = LinksCards(I).cValue
                            HöchstePosition = I
                        End If
                    Next I
                    If HöchsterWert <> 0 Then
                        'Rot gefunden
                        SucheBesteKarteRotOderSticheMitspieler = HöchstePosition
                        Exit Function
                    End If
                End If
                'sonst höchste Karte abwerfen
                HöchsterWert = 0
                For I = 1 To UBound(LinksCards)
                    If LinksCards(I).cValue >= HöchsterWert Then
                        HöchsterWert = LinksCards(I).cValue
        ...
        If blnFarbeVorhanden = False Then
            ...
            If AKIndex < 8 Then                                             'Die ersten zwei Stiche
                ...
                For I = 1 To UBound(MitteCards)
                    ...
                    End If
                Next I
                SucheBesteKarteRotOderSticheMitspieler = NachbehandlungAbwerfen(MitteCards, HöchstePosition)
                Exit Function
            Else
                'es ist der dritte oder weitere Stich
                'Bei Rot vorrangig höchste Rot abwerfen                     'Gerbing 13.10.2017
                If Spielart = Rot Then
                    HöchsterWert = 0
                    For I = 1 To UBound(MitteCards)
                        If MitteCards(I).cValue >= HöchsterWert And MitteCards(I).cType = 2 Then '2=Rot
                            HöchsterWert = MitteCards(I).cValue
                            HöchstePosition = I
                        End If
                    Next I
        ...
        If blnFarbeVorhanden = False Then
            ...
            If AKIndex < 8 Then                                            'Die ersten zwei Stiche
                ...
                For I = 1 To UBound(RechtsCards)
                    ...
                    End If
                Next I
                SucheBesteKarteRotOderSticheMitspieler = NachbehandlungAbwerfen(RechtsCards, HöchstePosition)
                Exit Function
            Else
                'es ist der dritte oder weitere Stich
                'Bei Rot vorrangig höchste Rot abwerfen                     'Gerbing 13.10.2017
                If Spielart = Rot Then
                    HöchsterWert = 0
                    For I = 1 To UBound(RechtsCards)
                        If RechtsCards(I).cValue >= HöchsterWert And RechtsCards(I).cType = 2 Then '2=Rot
                            HöchsterWert = RechtsCards(I).cValue
                            HöchstePosition = I
                        End If
                    Next I
...
Private Sub lblRoserl_Click(Index As Integer)
    If blnNeuesSpielBeginnt = True Then
        ...
        If AusspielerBeiSpielbeginn = Links Then
            'Links Mitte und Rechts müssen noch ausspielen
            Call LinksPlay
            Call MittePlay
            Call RechtsPlay
        End If
        ...
        If AusspielerBeiSpielbeginn = Spieler Then
            ...
            'MsgBox bringen wenn der Spieler 10 Sekunden schläft
            SchlafTimer.Enabled = True
        End If
    End If
End Sub

Private Function NachbehandlungAbwerfen(computercards() As cRoserl, HöchstePosition As Integer)
    'Anstelle von DieHöchsteAbwerfen ist es manchmal besser DieEinzigeAbwerfen
    ...
    'außer ich kann keine andere abwerfen, dazu dient der Aufruf von HatKeinerMehr
    
    'NachbehandlungAbwerfen soll herausfinden ob die Karte HöchstePosition lieber nicht abgeworfen werden soll
    'Wenn keine bessere Karte gefunden wird, dann doch die nehmen, die bei Aufruf der Funktion in HöchstePosition stand
    
    Dim SaveHöchstePosition As Integer
    Dim I As Integer
    Dim zählerMK As Integer                                             'zähler Meine Karten
    Dim SRGEPosition As Integer                                         'Schell Rot Grün Eichel Position
    Dim rc As Integer

    SaveHöchstePosition = HöchstePosition
    'wenn die empfohlene Karte bereits die einzige ist, nichts tun
    zählerMK = 0
    For I = 1 To UBound(computercards)
        If computercards(I).cType = computercards(HöchstePosition).cType Then
            zählerMK = zählerMK + 1
        End If
    Next I
    If zählerMK = 1 Then
        'es ist die einzige, nichts tun
        NachbehandlungAbwerfen = SaveHöchstePosition
        Exit Function
    End If
    '------------------------------------------------------------------------------------------
    'zählerMK ist höher als 1
    If computercards(HöchstePosition).cType = 1 Then
    'Die empfohlene Karte war Schell und sie war nicht die einzige, probiere es mit rot oder grün oder eichel, ob dies die einzige ist
        ...
        zählerMK = 0
        For I = 1 To UBound(computercards)
            If computercards(I).cType = 3 Then                              'cType=3=Grün
                zählerMK = zählerMK + 1
                SRGEPosition = I
            End If
        Next I
        If zählerMK = 1 Then
            'es gibt nur eine Grün
            If computercards(SRGEPosition).cValue > 3 Then              'cValue=3=Neun
                'wenn es nicht gerade die 7 oder 8 oder 9 ist, nimm diese Grün
                rc = HatKeinerMehr(computercards, SRGEPosition)         'Gerbing 15.10.2017
                If rc <> 0 Then
                    'die hat keiner mehr
                    NachbehandlungAbwerfen = SaveHöchstePosition
    ...
    End If
    '------------------------------------------------------------------------------------------
    If computercards(HöchstePosition).cType = 2 Then
    'Die empfohlene Karte war Rot und sie war nicht die einzige, probiere es mit schell oder grün oder eichel, ob dies die einzige ist
        'mit Schell
        zählerMK = 0
        For I = 1 To UBound(computercards)
    ...
    End If
    '------------------------------------------------------------------------------------------
    If computercards(HöchstePosition).cType = 3 Then
    'Die empfohlene Karte war Grün und sie war nicht die einzige, probiere es mit schell oder Rot oder eichel, ob dies die einzige ist
        'mit Schell
        zählerMK = 0
        For I = 1 To UBound(computercards)
            If computercards(I).cType = 1 Then                              'cType=1=Schell
    ...
    End If
    '------------------------------------------------------------------------------------------
    If computercards(HöchstePosition).cType = 4 Then
    'Die empfohlene Karte war Eichel und sie war nicht die einzige, probiere es mit schell oder Rot oder grün, ob dies die einzige ist
        'mit Schell
        zählerMK = 0
        For I = 1 To UBound(computercards)
            If computercards(I).cType = 1 Then                              'cType=1=Schell
...
Private Function NachbehandlungAusspieler(computercards() As cRoserl, NiedrigstePosition As Integer)
    'wird aufgerufen von: Rot_N2 Ober Stiche ErsterUndLetzter RoterKönig
    ...
    'dafür wird sie gekennzeichnet in cGespieltVon mit 1 als BeiErneutemSuchenÜberspringen.
    ...
    Dim I As Integer
    Dim zählerAK As Integer                                             'zähler Ausgespielte Karten
    Dim zählerMK As Integer                                             'zähler Meine Karten
    Dim NiedrigsterWert As Integer
    ...
    'Kontrolliere ob eine Farbe gespielt werden soll, von der bereits alle Karten ausgespielt sind
    'das ist dann der Fall wenn zählerAK plus zählerMK = 8
    zählerAK = 0
    For I = 1 To AKIndex
    ...
    For I = 1 To UBound(computercards)
        ...
        End If
    Next I
    If zählerAK + zählerMK = 8 Then
        'weil schon alle ausgespielt eine andere Farbe suchen
        NiedrigstePosition = 0
        NiedrigsterWert = 8                                             '8=Ass=Startwert
        For I = 1 To UBound(computercards)
            If computercards(I).cGespieltVon <> 1 Then                  'Gerbing 13.10.2017 beim erneuten Suchen überspringen
                'Gerbing 13.10.2017 und diese Farbe überspringen die hat keiner mehr
...
Private Function NachbehandlungMitspieler(computercards() As cRoserl, NiedrigstePosition As Integer)
    ...
    'wenn eine Farbe zum erstenmal gespielt wird, ist zu prüfen, ob der Computer von dieser Farbe Farbe eine hohe und eine niedrige Karte hat.
    ...
    If computercards(NiedrigstePosition).cType = 1 Then                 '1=Schell
        ...
        If blnSchellZEM = True Then
            ...
            If zählerMK = 1 Then
                ...
                Exit Function
            Else
                'ich habe mehrere Schell, suche die höchste
                HöchsterWert = 0
                For I = 1 To UBound(computercards)
                    If computercards(I).cType = 1 Then                  '1=Schell
                        If computercards(I).cValue >= HöchsterWert Then
                            HöchsterWert = computercards(I).cValue
                            HöchstePosition = I
                        End If
                    End If
                Next I
                NachbehandlungMitspieler = HöchstePosition
                Exit Function
            End If
        Else
    ...
    If computercards(NiedrigstePosition).cType = 2 Then                 '2=rot
        ...
        If blnRotZEM = True Then
            ...
            If zählerMK = 1 Then
                ...
                Exit Function
            Else
                'ich habe mehrere Rot, suche die höchste
                HöchsterWert = 0
                For I = 1 To UBound(computercards)
    ...
    End If
    '-------------------------------------------------------
    If computercards(NiedrigstePosition).cType = 3 Then                 '3=Grün
        'ich muss Grün zugeben
        If computercards(NiedrigstePosition).cValue = 1 Or computercards(NiedrigstePosition).cValue = 2 Or computercards(NiedrigstePosition).cValue = 3 Then
            ' es ist 7 oder 8 oder 9
        Else
            'es ist höher als 9
            ...
            Exit Function
        End If
        If blnGrünZEM = True Then
            'es ist 7 oder 8 oder 9 und Grün zum ersten mal gespielt
            blnGrünZEM = False
            zählerMK = 0
            For I = 1 To UBound(computercards)
                If computercards(I).cType = 1 Then
            ...
            Next I
            If zählerMK = 1 Then
                'ich habe nur eine Grün
                NachbehandlungMitspieler = SaveNiedrigstePosition
                Exit Function
            Else
                'ich habe mehrere Grün, suche die höchste
                HöchsterWert = 0
                For I = 1 To UBound(computercards)
                    If computercards(I).cType = 3 Then                  '3=grün
                        If computercards(I).cValue >= HöchsterWert Then
                            HöchsterWert = computercards(I).cValue
                            HöchstePosition = I
                        End If
    ...
    If computercards(NiedrigstePosition).cType = 4 Then                 '4=Eichel
        ...
        If blnEichelZEM = True Then
            ...
            If zählerMK = 1 Then
                ...
                Exit Function
            Else
                'ich habe mehrere Eichel, suche die höchste
                HöchsterWert = 0
                For I = 1 To UBound(computercards)
...
Private Function SucheBesteKarteOberMitspieler()
    ...
    'Wenn abgeworfen werden kann, zuerst einen Ober abwerfen,
    'wenn zugegeben werden muss und es ist eine höhere Karte auf dem Tisch als Ober, dann den Ober zugeben
    ...
    Dim blnFarbeVorhanden As Boolean
    Dim blnHöherAlsOber As Boolean
    ...
    'liegt eine höhere Karte auf dem Tisch als Ober?                            'Gerbing 06.07.2017
    blnHöherAlsOber = False
    ...
    End If
    'ist der Ober bereits in einem früheren Stich gespielt?
    ...
    If PlayerTurn = Links Then
        ...
        If blnFarbeVorhanden = False Then
            ...
            'Suche einen Ober, sonst die höchste
            HöchsterWert = 0
            For I = 1 To UBound(LinksCards)
                If LinksCards(I).cValue = 6 Then                        '6=Ober
                    HöchstePosition = I
                ...
                End If
            Next I
            SucheBesteKarteOberMitspieler = HöchstePosition
            Exit Function
        Else
            ...
            'wenn zugegeben werden muss und es ist eine höhere Karte auf dem Tisch als Ober, dann den Ober zugeben, falls ich ihn habe
            NiedrigsterWert = 8                                         '8=Ass=Startwert
            OberPosition = 0
            If blnHöherAlsOber = True Then                                                  'Gerbing 06.07.2017
                'es ist eine höhere Karte auf dem Tisch als Ober
                For I = 1 To UBound(LinksCards)
            ...
            'sonst eine höhere als den Ober                              'Gerbing 06.07.2017
            NiedrigsterWert = 8                                         '8=Ass=Startwert
            NiedrigstePosition = 0
            For I = 1 To UBound(LinksCards)
                If LinksCards(I).cType = AKType Then
            ...
            If LinksCards(NiedrigstePosition).cValue = 6 Then         '6=Ober Gerbing 06.07.2017
                'den Ober nicht spielen wenn noch eine höhere Karte da ist
                HöchsterWert = 6
                HöchstePosition = 0
                For I = 1 To UBound(LinksCards)
                    If LinksCards(I).cType = AKType Then
                    ...
                    End If
                Next I
                If HöchstePosition <> 0 Then
                    NiedrigstePosition = HöchstePosition
                End If
            End If
            SucheBesteKarteOberMitspieler = NiedrigstePosition
            Exit Function
...
Private Function SucheBesteKarteRoterKönigAusspieler()
    'Der Computer ist Ausspieler
    'wenn ausgespielt werden muss, RoterKönig nur, wenn es die letzte Karte ist
    'ansonsten die niedrigste
    'aber nicht, wenn diese Farbe keiner mehr hat                   'Gerbing 15.10.2017
    ...
    Dim NiedrigsterWert As Integer
    Dim NiedrigstePosition As Integer
    Dim RoterKönigPosition As Integer
    Dim SaveNiedrigstePosition As Integer
    ...
    If PlayerTurn = Links Then
        For I = 1 To UBound(LinksCards)
            If LinksCards(I).cValue = 7 And LinksCards(I).cType = 2 Then    'RoterKönig
                RoterKönigPosition = I
            Else
                If LinksCards(I).cValue <= NiedrigsterWert Then
                    NiedrigsterWert = LinksCards(I).cValue
                    NiedrigstePosition = I
        ...
        Next I
        If NiedrigstePosition = 0 Then
            'hier gibt es nur RoterKönig
            NiedrigstePosition = 1
        End If
        SaveNiedrigstePosition = NiedrigstePosition                  'Gerbing 15.10.2017
        SucheBesteKarteRoterKönigAusspieler = NachbehandlungAusspieler(LinksCards, NiedrigstePosition)    'Gerbing 15.10.2017
        If LinksCards(SucheBesteKarteOberAusspieler).cValue = 7 And LinksCards(SucheBesteKarteOberAusspieler).cType = 2 Then    'RoterKönig
            SucheBesteKarteRoterKönigAusspieler = SaveNiedrigstePosition  'Gerbing 15.10.2017
        End If
        Exit Function
    End If
    If PlayerTurn = Mitte Then
        For I = 1 To UBound(MitteCards)
            If MitteCards(I).cValue = 7 And MitteCards(I).cType = 2 Then    'RoterKönig
                RoterKönigPosition = I
            Else
                If MitteCards(I).cValue <= NiedrigsterWert Then
                    NiedrigsterWert = MitteCards(I).cValue
        ...
        End If
        SaveNiedrigstePosition = NiedrigstePosition                  'Gerbing 15.10.2017
        SucheBesteKarteRoterKönigAusspieler = NachbehandlungAusspieler(MitteCards, NiedrigstePosition)    'Gerbing 15.10.2017
        If MitteCards(SucheBesteKarteOberAusspieler).cValue = 7 And MitteCards(SucheBesteKarteOberAusspieler).cType = 2 Then    'RoterKönig
            SucheBesteKarteRoterKönigAusspieler = SaveNiedrigstePosition  'Gerbing 15.10.2017
        End If
        Exit Function
    End If
    If PlayerTurn = Rechts Then
        For I = 1 To UBound(RechtsCards)
            If RechtsCards(I).cValue = 7 And RechtsCards(I).cType = 2 Then    'RoterKönig
                RoterKönigPosition = I
            Else
                If RechtsCards(I).cValue <= NiedrigsterWert Then
                    NiedrigsterWert = RechtsCards(I).cValue
        ...
        End If
        SaveNiedrigstePosition = NiedrigstePosition                  'Gerbing 15.10.2017
        SucheBesteKarteRoterKönigAusspieler = NachbehandlungAusspieler(RechtsCards, NiedrigstePosition)    'Gerbing 15.10.2017
        If RechtsCards(SucheBesteKarteOberAusspieler).cValue = 7 And RechtsCards(SucheBesteKarteOberAusspieler).cType = 2 Then    'RoterKönig
            SucheBesteKarteRoterKönigAusspieler = SaveNiedrigstePosition  'Gerbing 15.10.2017
        End If
        Exit Function
    End If
...
Private Function SucheBesteKarteRoterKönigMitspieler()
    'Der Computer ist Mitspieler
    'Wenn abgeworfen werden kann, zuerst RoterKönig abwerfen,
    'wenn zugegeben werden muss und es ist eine höhere Karte gespielt als RoterKönig, dann RoterKönig zugeben
    'wenn zugegeben werden muss und es ist eine niedrigere Karte gespielt als RoterKönig, RoterKönig nur wenn er der letzte von Rot ist
    'Wenn der RoterKönig noch nicht gespielt wurde und nicht auf dem Tisch liegt
    'und ich bin der 4.Zugeber(3 Karten liegen auf dem Tisch) -> VorbehandlungRoterKönig(die höchste Rot zugeben Ass)
    ...
    Dim AKType As Integer                                                   'AusgespielteKarteType
    Dim AKValue As Integer                                                   'AusgespielteKarteValue
    Dim KönigPosition As Integer
    Dim blnFarbeVorhanden As Boolean
    Dim blnRoterKönigAufDemTisch As Boolean
    Dim blnRotAssAufDemTisch As Boolean                                     'Gerbing 08.12.2017
'    Dim blnRoterKönigSchonGespielt As Boolean
    ...
    End If
    'liegt der RoterKönig auf dem Tisch?                                            'Gerbing 16.10.2017 19.12.2017
    blnRoterKönigAufDemTisch = False
    ...
    If PlayerTurn = Links Then
        ...
        If blnFarbeVorhanden = False Then
            'Farbe nicht vorhanden, es darf abgeworfen werden
            'Computer hat nicht die geforderte Farbe, soll vorrangig RoterKönig oder RotAss abwerfen    'Gerbing 09.12.2017
            'Suche RoterKönig oder RotAss, sonst die höchste                                            'Gerbing 09.12.2017
            HöchsterWert = 0
            For I = 1 To UBound(LinksCards)
                If LinksCards(I).cValue = 7 And LinksCards(I).cType = 2 Then                'RoterKönig
                    HöchstePosition = I
                    SucheBesteKarteRoterKönigMitspieler = HöchstePosition
                    Exit Function
                Else
        ...
        Else
            ...
            'oder RotAss liegt auf dem Tisch -> VorbehandlungRoterKönig(die höchste Rot zugeben)'Gerbing 08.12.2017
            If blnRoterKönigAufDemTisch = False And blnMitteWarDran = True And blnRechtsWarDran = True And blnSpielerWarDran = True Then
                SucheBesteKarteRoterKönigMitspieler = VorbehandlungRoterKönig(LinksCards, PlayerTurn, AKType)  'Gerbing 16.10.2017
                If SucheBesteKarteRoterKönigMitspieler <> 0 Then                        'Gerbing 28.11.2017
                    Exit Function
                End If
            End If
            'sonst, Farbe ist vorhanden, es muss zugegeben werden, ich bin nicht der 4.Zugeber
            'wenn zugegeben werden muss und es ist eine höhere Karte gespielt als RoterKönig, dann den RoterKönig zugeben, falls ich ihn habe
            NiedrigsterWert = 8                                                         '8=Ass=Startwert
            KönigPosition = 0
            If blnRotAssAufDemTisch = True And AKType = 2 Then                                          'Gerbing 08.12.2017 19.12.2017
                'Rot muss zugegeben werden es ist eine höhere Karte auf dem Tisch als RoterKönig
                For I = 1 To UBound(LinksCards)
                    If LinksCards(I).cValue = 7 And LinksCards(I).cType = 2 Then         'RoterKönig
                        KönigPosition = I
                    Else
                    ...
                    End If
                Next I
                If KönigPosition <> 0 Then
                    'ich gebe den RoterKönig zu
                    NiedrigstePosition = KönigPosition
                End If
                SucheBesteKarteRoterKönigMitspieler = NiedrigstePosition
                Exit Function
            End If
            '-----------------------------------------------------------------------------
            'wenn zugegeben werden muss und es ist eine niedrigere Karte gespielt als RoterKönig, den RoterKönig nur spielen
            ...
            Next I
            If NiedrigstePosition = 0 Then
                'es gibt nur noch den RoterKönig
                NiedrigstePosition = KönigPosition
            End If
            SucheBesteKarteRoterKönigMitspieler = NiedrigstePosition
            Exit Function
...
'--------------------------------------------------------------------------------------------------
    If PlayerTurn = Mitte Then
        ...
        Else
            ...
            'oder RotAss liegt auf dem Tisch -> VorbehandlungRoterKönig(die höchste Rot zugeben)'Gerbing 08.12.2017
            If blnRoterKönigAufDemTisch = False And blnMitteWarDran = True And blnRechtsWarDran = True And blnSpielerWarDran = True Then
                SucheBesteKarteRoterKönigMitspieler = VorbehandlungRoterKönig(MitteCards, PlayerTurn, AKType)  'Gerbing 16.10.2017
                If SucheBesteKarteRoterKönigMitspieler <> 0 Then                        'Gerbing 28.11.2017
                    Exit Function
                End If
            End If
            ...
            KönigPosition = 0
            If blnRotAssAufDemTisch = True And AKType = 2 Then                                          'Gerbing 08.12.2017 19.12.2017
                'es ist eine höhere Karte auf dem Tisch als RoterKönig
                For I = 1 To UBound(MitteCards)
                    If MitteCards(I).cValue = 7 And MitteCards(I).cType = 2 Then         'RoterKönig
                        KönigPosition = I
                    Else
...
'--------------------------------------------------------------------------------------------------
    If PlayerTurn = Rechts Then
        ...
        Else
            ...
            'oder RotAss liegt auf dem Tisch -> VorbehandlungRoterKönig(die höchste Rot zugeben)'Gerbing 08.12.2017
            If blnRoterKönigAufDemTisch = False And blnMitteWarDran = True And blnRechtsWarDran = True And blnSpielerWarDran = True Then
                SucheBesteKarteRoterKönigMitspieler = VorbehandlungRoterKönig(RechtsCards, PlayerTurn, AKType)  'Gerbing 16.10.2017
                If SucheBesteKarteRoterKönigMitspieler <> 0 Then                        'Gerbing 28.11.2017
                    Exit Function
                End If
            End If
...
'    Der Ausspieler soll ab 2. Stich entweder seine einzige Farbe oder seine höchste Karte ausspielen.
'    NachbehandlungAusspieler prüft, ob eine Karte gespielt werden soll die kein anderer mehr hat

'    Wenn der Mitspieler zugeben muss spielt er seine höchste Karte
'    Wenn der Mitspieler abwerfen kann, wirft er seine höchste ab oder seine einzige wenn es nicht gerade die 7 ist(NachbehandlungAbwerfen)
    Dim I As Integer
    Dim NiedrigsterWert As Integer
    Dim NiedrigstePosition As Integer
    Dim HöchsterWert As Integer
    ...
    If Ausspieler = PlayerTurn Then
        ...
        If AKIndex >= 20 Then                                               'Gerbing 17.10.2017
            ...
            Exit Function
        End If
        'hier ist es das zweite bis fünfte Aussspielen
        HöchsterWert = 0
        If PlayerTurn = Links Then
            For I = 1 To UBound(LinksCards)
                If LinksCards(I).cValue >= HöchsterWert Then
                ...
                End If
            Next I
            SucheBesteKarteErsterUndLetzter = NachbehandlungAusspieler(LinksCards, HöchstePosition)
            Exit Function
        End If
        If PlayerTurn = Mitte Then
            For I = 1 To UBound(MitteCards)
                ...
                End If
            Next I
            SucheBesteKarteErsterUndLetzter = NachbehandlungAusspieler(MitteCards, HöchstePosition)
            Exit Function
        End If
        If PlayerTurn = Rechts Then
            For I = 1 To UBound(RechtsCards)
                ...
                End If
            Next I
            SucheBesteKarteErsterUndLetzter = NachbehandlungAusspieler(RechtsCards, HöchstePosition)
            Exit Function
        End If
    End If
    '---------------------------------------------------------------------------------------------------------------------
    ...
    ElseIf Ausspieler = Spieler Then
        ...
        AKValue = SpielerGespielt.CardValue
    End If
'    Wenn der Mitspieler zugeben muss spielt er beim ersten Stich seine niedrigste Karte, ab 2.Stich seine höchste Karte
'    Wenn der Mitspieler abwerfen kann, wirft er seine höchste ab oder seine einzige wenn es nicht gerade die 7 ist(NachbehandlungAbwerfen)
    ...
    If PlayerTurn = Links Then
        ...
        If blnFarbeVorhanden = False Then
            ...
            For I = 1 To UBound(LinksCards)
                ...
                'End If
            Next I
            SucheBesteKarteErsterUndLetzter = NachbehandlungAbwerfen(LinksCards, HöchstePosition)
            Exit Function
        Else
            'Farbe ist vorhanden
            'Wenn der Mitspieler zugeben muss spielt er beim ersten Stich seine niedrigste Karte, ab 2.Stich seine höchste Karte
            ...
            For I = 1 To UBound(LinksCards)
                ...
                End If
            Next I
            SucheBesteKarteErsterUndLetzter = HöchstePosition
            Exit Function
        End If
    End If
'--------------------------------------------------------------------------------------------------
    If PlayerTurn = Mitte Then
        ...
        If blnFarbeVorhanden = False Then
            ...
            For I = 1 To UBound(MitteCards)
                ...
                'End If
            Next I
            SucheBesteKarteErsterUndLetzter = NachbehandlungAbwerfen(MitteCards, HöchstePosition)
            Exit Function
        Else
            'Farbe ist vorhanden
            'Wenn der Mitspieler zugeben muss spielt er beim ersten Stich seine niedrigste Karte, ab 2.Stich seine höchste Karte
    ...
    If PlayerTurn = Rechts Then
        ...
        If blnFarbeVorhanden = False Then
            ...
            For I = 1 To UBound(RechtsCards)
                ...
                'End If
            Next I
            SucheBesteKarteErsterUndLetzter = NachbehandlungAbwerfen(RechtsCards, HöchstePosition)
            Exit Function
        Else
            'Farbe ist vorhanden
            'Wenn der Mitspieler zugeben muss spielt er beim ersten Stich seine niedrigste Karte, ab 2.Stich seine höchste Karte
...
Private Function SucheBesteKarteLorumAusspieler()
    ...
    'An auf dem Tisch liegende Karten dürfen abwärts weitere Karten angelegt werden
    'Es soll versucht werden eine aufsteigende Kartenfolge einer Farbe mit maximal 4 Karten zu erzeugen
    '   dabei ist es möglich dass andere Mitspieler Karten spielen müssen die in der Kartenfolge fehlen
    '   Der Computer kann alle Karten durchsuchen, dann weis er, wer diese Karte hat
    'Wenn der Ausspieler nicht mehr weiter kann, kommt als nächster Spieler der dran, der die letzte Karte einer vom
...
'        frmMsgBox.Show 1
    ...
    End If
    '-----------------------------------------------------------------------------------
    'Der Ausspieler darf an auf dem Tisch liegende Karten abwärts weitere Karten ablegen
    'Hier suche ich Ablegekarten
    'MsgBox "Der letzte Ausspieler darf weiter ausspielen"
    Do                                                      'Schleife es dürfen mehrere Karten abgelegt werden
        rc = LorumAbwärtsAblegen()
    ...
    'Wenn der Ausspieler nicht mehr weiter kann, kommt als nächster Spieler der dran, der die letzte Karte einer vom
    'Ausspieler begonnenen Kartenfolge hinlegt. Der Computer weis, wer die benötigte Karte hat
...
Private Function LorumKartenFolge(blnLoopBenutzen As Boolean)
    ...
    Dim blnNächsteGefunden As Boolean
        ...
        If PlayerTurn = Spieler Then
            For I = 1 To UBound(SpielerCards)
                ...
                If LorumStartWert < 6 Then                                           '6=Ober
                    'durchsuche alle anderen Karten außer der mit LorumStartWert, ob sie LorumStartWert+3 enthält und die gleiche Farbe hat
                    'und cGespieltVon <> 9
                    'Ober oder höher zu untersuchen ist witzlos
                    For n = 1 To UBound(SpielerCards)
    ...
    If blnLoopBenutzen = False Then                                         'Gerbing 26.09.2017
        ...
        Do
            ...
            If LorumAuflegeFarbe = 2 Then                                        '2=Rot
                ...
                End If
            End If
            If LorumAuflegeFarbe = 3 Then                                        '3=Grün
                If cdRoserlGrünA.Count <= 4 Then
                    If blnStapelBBenutzen = False Then
                        AP = cdRoserlGrünA.Count - 1
                        ZielPunktLeftLorum = cdRoserlGrünA(AP).Left             'Gerbing 25.09.2017
                        ZielPunktTopLorum = cdRoserlGrünA(AP).Top               'Gerbing 25.09.2017
                        Call MoveKarteLorum(LorumStartPosition - 1)             'Gerbing 25.09.2017
                        cdRoserlGrünA(AP).CardType = 3
                        cdRoserlGrünA(AP).CardValue = LorumStartWert
                        cdRoserlGrünA(AP).FaceMode = NachOben
                        cdRoserlGrünA(AP).Left = cdRoserlGrünA(0).Left + (CARD_SPACE / 2 * AP)
                        cdRoserlGrünA(AP).Top = cdRoserlGrünA(0).Top
                        cdRoserlGrünA(AP).Visible = True
                        On Error Resume Next                                'Gerbing 25.09.2017
                        Load cdRoserlGrünA(AP + 1)
                        On Error GoTo 0
                    End If
                End If
                If blnStapelBBenutzen = True Then
                    AP = cdRoserlGrünB.Count - 1
                    ZielPunktLeftLorum = cdRoserlGrünB(AP).Left             'Gerbing 25.09.2017
                    ZielPunktTopLorum = cdRoserlGrünB(AP).Top               'Gerbing 25.09.2017
                    Call MoveKarteLorum(LorumStartPosition - 1)             'Gerbing 25.09.2017
                    cdRoserlGrünB(AP).CardType = 3
                    cdRoserlGrünB(AP).CardValue = LorumStartWert
                    cdRoserlGrünB(AP).FaceMode = NachOben
                    cdRoserlGrünB(AP).Left = cdRoserlGrünB(0).Left + (CARD_SPACE / 2 * AP)
                    cdRoserlGrünB(AP).Top = cdRoserlGrünB(0).Top
                    cdRoserlGrünB(AP).Visible = True
                    On Error Resume Next                                'Gerbing 25.09.2017
                    Load cdRoserlGrünB(AP + 1)
                    On Error GoTo 0
                End If
            End If
            ...
            If LorumAufgelegtZähler = 4 Then
                LorumAufgelegtZähler = 0
                LorumKartenFolge = 0                    'Kartenfolge nicht erzeugbar
                Exit Function
            End If
            '--------------------------------------------------------------------------
            'Wem gehört die nächste Karte
            LorumStartWert = LorumStartWert + 1
            blnNächsteGefunden = False
            If LorumStartWert = 9 Then                                          'Gerbing 05.10.2017
                GoTo NächsteGefunden
            End If
            For n = 1 To UBound(LinksCards)
                If LinksCards(n).cValue = LorumStartWert And LinksCards(n).cType = LorumAuflegeFarbe And LinksCards(n).cGespieltVon <> 9 Then
                    ...
                    If LorumStartWert = 7 Then strWert = "König"
...
'                    frmMsgBox.Show 1
                    'Für MoveKarteLorum den StartPunkt festlegen                'Gerbing 25.09.2017
            ...
            For n = 1 To UBound(MitteCards)
                If MitteCards(n).cValue = LorumStartWert And MitteCards(n).cType = LorumAuflegeFarbe And MitteCards(n).cGespieltVon <> 9 Then
                    ...
                    If MitteCards(n).cType = 3 Then strFarbe = "Grün"
...
'                    frmMsgBox.Show 1
            ...
            For n = 1 To UBound(RechtsCards)
                If RechtsCards(n).cValue = LorumStartWert And RechtsCards(n).cType = LorumAuflegeFarbe And RechtsCards(n).cGespieltVon <> 9 Then
                    ...
                    If RechtsCards(n).cType = 3 Then strFarbe = "Grün"
...
'                    frmMsgBox.Show 1
            ...
            For n = 1 To UBound(SpielerCards)
                ...
                If SpielerCards(n).cValue = LorumStartWert And SpielerCards(n).cType = LorumAuflegeFarbe And SpielerCards(n).cGespieltVon <> 9 Then
                    ...
                    If SpielerCards(n).cType = 3 Then strFarbe = "Grün"
...
'                    frmMsgBox.Show 1
            ...
            Next n
NächsteGefunden:
            If blnNächsteGefunden = False Then
            ...
            End If
            If LorumAufgelegtZähler = 0 Then
                LorumAufgelegtZähler = 1
            End If
            LorumAufgelegtZähler = LorumAufgelegtZähler + 1
            If blnLoopBenutzen = False Then Exit Function
        Loop
    End If
End Function

Private Function LorumAbwärtsAblegen()
    'rc = 0 keine Anlegekarte gefunden
    'rc = 1 Anlegekarte gefunden
    'Der Computer durchsucht die Spieler Links Mitte Rechts Karten, ob an eine auf dem Tisch liegende Karte abwärts angelegt werden kann
    
    Dim I As Integer
    Dim n As Integer
    Dim AP As Integer                                                   'AP=Anlegeposition
    Dim GKP As Integer                                                  'GKP=GespielteKartePosition wird fürs Entladen gebraucht
    Dim AnlegeWert As Integer
    Dim blnSchellAssAnlegekarteGefunden As Boolean
    Dim blnRotAssAnlegekarteGefunden As Boolean
    Dim blnGrünAssAnlegekarteGefunden As Boolean
    ...
    Dim blnGrünAAnlegekarteGefunden As Boolean
    Dim blnGrünBAnlegekarteGefunden As Boolean
    ...
    For I = 0 To cdRoserlEichelB.Count - 1                              'für EichelB
            ...
            For I = 1 To 8
                If SpielerCards(I).cValue = AnlegeWert And SpielerCards(I).cType = 4 And SpielerCards(I).cGespieltVon <> 9 Then    '4=Eichel
                    ...
                    If SpielerCards(I).cValue = LorumStartWert And SpielerCards(I).cType = LorumAuflegeFarbe Then           'Gerbing 26.09.2017
                        ...
                        GKP = I                                                 'GKP=GespielteKartePosition wird fürs Entladen gebraucht
                        Exit For
                    End If
                End If
            Next I
    ...
    For I = 0 To cdRoserlEichelA.Count - 1                              'für EichelA
    ...
    '-----------------------------------------------
    AP = 0
    blnGrünAAnlegekarteGefunden = False
    For I = 0 To cdRoserlGrünA.Count - 1                              'für GrünA
        If cdRoserlGrünA(I).Visible = True Then                       'bei Visible=true ist sie aufgelegt
            AP = I + 1                                                  'AP sagt nur ob dieser Stapel sichtbar ist
        End If
    Next I
    If AP <> 0 Then
        'Der anzulegende Wert ist eins unterhalb der am weitesten links liegenden karte
        AnlegeWert = cdRoserlGrünA(0).CardValue - 1
        If PlayerTurn = Spieler Then
            For I = 1 To 8
                If SpielerCards(I).cValue = AnlegeWert And SpielerCards(I).cType = 3 And SpielerCards(I).cGespieltVon <> 9 Then    '3=Grün
                    'Jetzt muss ich fragen ob die gefundene Ablegekarte auch vom Spieler angeklickt wurde.
                    'Wenn nein bleibt blnGrünAAnlegekarteGefunden = False
                    'und es geht weiter mit dem Finden einer anderen Ablegekarte.
                    'Wenn ja geht es zu GoTo KarteAuflegen
                    If SpielerCards(I).cValue = LorumStartWert And SpielerCards(I).cType = LorumAuflegeFarbe Then           'Gerbing 26.09.2017
                        blnGrünAAnlegekarteGefunden = True
                        GKP = I                                                 'GKP=GespielteKartePosition wird fürs Entladen gebraucht
                        Exit For
                    End If
                End If
        ...
        If PlayerTurn = Links Then
            For I = 1 To 8
                If LinksCards(I).cValue = AnlegeWert And LinksCards(I).cType = 3 And LinksCards(I).cGespieltVon <> 9 Then    '3=Grün
                    blnGrünAAnlegekarteGefunden = True
                    GKP = I                                                 'GKP=GespielteKartePosition wird fürs Entladen gebraucht
                    Exit For
                End If
        ...
        If PlayerTurn = Mitte Then
            For I = 1 To 8
                If MitteCards(I).cValue = AnlegeWert And MitteCards(I).cType = 3 And MitteCards(I).cGespieltVon <> 9 Then    '3=Grün
                    blnGrünAAnlegekarteGefunden = True
                    GKP = I                                                 'GKP=GespielteKartePosition wird fürs Entladen gebraucht
                    Exit For
                End If
        ...
        If PlayerTurn = Rechts Then
            For I = 1 To 8
                If RechtsCards(I).cValue = AnlegeWert And RechtsCards(I).cType = 3 And RechtsCards(I).cGespieltVon <> 9 Then    '3=Grün
                    blnGrünAAnlegekarteGefunden = True
                    GKP = I                                                 'GKP=GespielteKartePosition wird fürs Entladen gebraucht
                    Exit For
                End If
        ...
        End If
    End If
    If blnGrünAAnlegekarteGefunden = True Then
        GoTo KarteAuflegen
    End If
    '-----------------------------------------------
    AP = 0
    blnGrünBAnlegekarteGefunden = False
    For I = 0 To cdRoserlGrünB.Count - 1                              'für GrünB
        If cdRoserlGrünB(I).Visible = True Then                       'bei Visible=true ist sie aufgelegt
            AP = I + 1                                                  'AP sagt nur ob dieser Stapel sichtbar ist
        End If
    Next I
    If AP <> 0 Then
        'Der anzulegende Wert ist eins unterhalb der am weitesten links liegenden karte
        AnlegeWert = cdRoserlGrünB(0).CardValue - 1
        If PlayerTurn = Spieler Then
            For I = 1 To 8
                If SpielerCards(I).cValue = AnlegeWert And SpielerCards(I).cType = 3 And SpielerCards(I).cGespieltVon <> 9 Then    '3=Grün
                    'Jetzt muss ich fragen ob die gefundene Ablegekarte auch vom Spieler angeklickt wurde.
                    'Wenn nein bleibt blnGrünBAnlegekarteGefunden = False
                    'und es geht weiter mit dem Finden einer anderen Ablegekarte.
                    'Wenn ja geht es zu GoTo KarteAuflegen
                    If SpielerCards(I).cValue = LorumStartWert And SpielerCards(I).cType = LorumAuflegeFarbe Then           'Gerbing 26.09.2017
                        blnGrünBAnlegekarteGefunden = True
                        GKP = I                                                 'GKP=GespielteKartePosition wird fürs Entladen gebraucht
                        Exit For
                    End If
                End If
        ...
        End If
    End If
    If blnGrünBAnlegekarteGefunden = True Then
        GoTo KarteAuflegen
    End If
    '-----------------------------------------------
    AP = 0
    blnRotAAnlegekarteGefunden = False
    For I = 0 To cdRoserlRotA.Count - 1                              'für RotA
    ...
    For I = 0 To cdRoserlRotB.Count - 1                              'für RotB
...
'----------------------------------------------
    ...
    For I = 0 To cdRoserlSchellA.Count - 1                              'für SchellA
...
'----------------------------------------------
    ...
    For I = 0 To cdRoserlSchellB.Count - 1                              'für SchellB
    ...
    For I = 0 To cdRoserlSchellAss.Count - 1                            'für SchellAss
    ...
    Next I
    If AP <> 0 Then
        'Der anzulegende Wert geht vom Ass=8 abwärts vermindert um die AP
        AnlegeWert = 8 - AP
        If PlayerTurn = Spieler Then
            For I = 1 To 8
                If SpielerCards(I).cValue = AnlegeWert And SpielerCards(I).cType = 1 And SpielerCards(I).cGespieltVon <> 9 Then    '1=Schell
...
'----------------------------------------------------------------------
    ...
    For I = 0 To cdRoserlRotAss.Count - 1                            'für rotAss
...
'----------------------------------------------------------------------
    AP = 0
    blnGrünAssAnlegekarteGefunden = False
    For I = 0 To cdRoserlGrünAss.Count - 1                            'für grünAss
        If cdRoserlGrünAss(I).Visible = True Then                     'bei Visible=true ist sie aufgelegt
            'finde die hinterste bereits aufgelegte Karte
            AP = I + 1
        End If
    Next I
    If AP <> 0 Then
        ...
        If PlayerTurn = Spieler Then
            For I = 1 To 8
                If SpielerCards(I).cValue = AnlegeWert And SpielerCards(I).cType = 3 And SpielerCards(I).cGespieltVon <> 9 Then    '3=grün
                    'Jetzt muss ich fragen ob die gefundene Ablegekarte auch vom Spieler angeklickt wurde.
                    'Wenn nein bleibt blnGrünAssAnlegekarteGefunden = False
                    'und es geht weiter mit dem Finden einer anderen Ablegekarte.
                    'Wenn ja geht es zu GoTo KarteAuflegen
                    If SpielerCards(I).cValue = LorumStartWert And SpielerCards(I).cType = LorumAuflegeFarbe Then           'Gerbing 26.09.2017
                        blnGrünAssAnlegekarteGefunden = True
                        GKP = I
                        Exit For
                    End If
                End If
        ...
        End If
    End If
    If blnGrünAssAnlegekarteGefunden = True Then GoTo KarteAuflegen
'----------------------------------------------------------------------
    AP = 0
    blnEichelAssAnlegekarteGefunden = False
    For I = 0 To cdRoserlEichelAss.Count - 1                            'für eichelAss
    ...
    '-----------------------------------------------
    If blnSchellAssAnlegekarteGefunden = False And blnRotAssAnlegekarteGefunden = False And blnGrünAssAnlegekarteGefunden = False _
        ...
        And blnGrünAAnlegekarteGefunden = False And blnGrünBAnlegekarteGefunden = False _
...
KarteAuflegen:
    ...
    End If
    If blnGrünBAnlegekarteGefunden = True Or blnGrünAAnlegekarteGefunden = True Or blnGrünAssAnlegekarteGefunden = True Then
        strFarbe = "Grün"
    ...
    If AnlegeWert = 7 Then strWert = "König"
...
'    gstrMsg = gstrMsg & "Wert=" & strWert
'    frmMsgBox.Show 1
    LorumAbwärtsAblegen = 1                                             'Anlegekarte gefunden
    '----------------------------------------------------------------------------------------
    ...
    If blnEichelBAnlegekarteGefunden = True Then
        ...
        If cdRoserlEichelB(0).CardValue + cdRoserlEichelB.Count = cdRoserlEichelB(cdRoserlEichelB.Count - 1).CardValue Then
            Load cdRoserlEichelB(cdRoserlEichelB.Count)                 'manchmal ist Load für eine zusätzliche Karte nötig
        End If
    ...
    If blnEichelAAnlegekarteGefunden = True Then
        ...
        If cdRoserlEichelA(0).CardValue + cdRoserlEichelA.Count = cdRoserlEichelA(cdRoserlEichelA.Count - 1).CardValue Then
            Load cdRoserlEichelA(cdRoserlEichelA.Count)                 'manchmal ist Load für eine zusätzliche Karte nötig
        End If
    ...
    End If
    If blnGrünBAnlegekarteGefunden = True Then
        ZielPunktLeftLorum = cdRoserlGrünB(0).Left              'Gerbing 25.09.2017
        ZielPunktTopLorum = cdRoserlGrünB(0).Top                'Gerbing 25.09.2017
        Call MoveKarteLorum(GKP - 1)                            'Gerbing 25.09.2017
        cdRoserlGrünB(0).CardType = 3
        cdRoserlGrünB(0).CardValue = AnlegeWert
        cdRoserlGrünB(0).FaceMode = NachOben
        cdRoserlGrünB(0).Left = cdRoserlGrünB(0).Left - (CARD_SPACE / 2)
        cdRoserlGrünB(0).Top = cdRoserlGrünB(0).Top
        AP = cdRoserlGrünB(0).Left                                    'Merke ganz linke Position
        If cdRoserlGrünB(0).CardValue + cdRoserlGrünB.Count = cdRoserlGrünB(cdRoserlGrünB.Count - 1).CardValue Then
            Load cdRoserlGrünB(cdRoserlGrünB.Count)                 'manchmal ist Load für eine zusätzliche Karte nötig
        End If
        For I = 0 To cdRoserlGrünB.Count - 1
            cdRoserlGrünB(I).Visible = True
            If I <> 0 Then
                cdRoserlGrünB(I).CardValue = AnlegeWert + I
                cdRoserlGrünB(I).Left = AP + (CARD_SPACE / 2 * I)
            End If
        Next I
    End If
    If blnGrünAAnlegekarteGefunden = True Then
        ZielPunktLeftLorum = cdRoserlGrünA(0).Left              'Gerbing 25.09.2017
        ZielPunktTopLorum = cdRoserlGrünA(0).Top                'Gerbing 25.09.2017
        Call MoveKarteLorum(GKP - 1)                            'Gerbing 25.09.2017
        cdRoserlGrünA(0).CardType = 3
        cdRoserlGrünA(0).CardValue = AnlegeWert
        cdRoserlGrünA(0).FaceMode = NachOben
        cdRoserlGrünA(0).Left = cdRoserlGrünA(0).Left - (CARD_SPACE / 2)
        cdRoserlGrünA(0).Top = cdRoserlGrünA(0).Top
        AP = cdRoserlGrünA(0).Left                                    'Merke ganz linke Position
        If cdRoserlGrünA(0).CardValue + cdRoserlGrünA.Count = cdRoserlGrünA(cdRoserlGrünA.Count - 1).CardValue Then
            Load cdRoserlGrünA(cdRoserlGrünA.Count)                 'manchmal ist Load für eine zusätzliche Karte nötig
        End If
        For I = 0 To cdRoserlGrünA.Count - 1
            cdRoserlGrünA(I).Visible = True
            If I <> 0 Then
                cdRoserlGrünA(I).CardValue = AnlegeWert + I
                cdRoserlGrünA(I).Left = AP + (CARD_SPACE / 2 * I)
            End If
        Next I
    End If
    If blnRotBAnlegekarteGefunden = True Then
        ...
        If cdRoserlRotB(0).CardValue + cdRoserlRotB.Count = cdRoserlRotB(cdRoserlRotB.Count - 1).CardValue Then
            Load cdRoserlRotB(cdRoserlRotB.Count)                 'manchmal ist Load für eine zusätzliche Karte nötig
        End If
    ...
    If blnRotAAnlegekarteGefunden = True Then
        ...
        If cdRoserlRotA(0).CardValue + cdRoserlRotA.Count = cdRoserlRotA(cdRoserlRotA.Count - 1).CardValue Then
            Load cdRoserlRotA(cdRoserlRotA.Count)                 'manchmal ist Load für eine zusätzliche Karte nötig
        End If
    ...
    If blnSchellBAnlegekarteGefunden = True Then
        ...
        If cdRoserlSchellB(0).CardValue + cdRoserlSchellB.Count = cdRoserlSchellB(cdRoserlSchellB.Count - 1).CardValue Then
            Load cdRoserlSchellB(cdRoserlSchellB.Count)                 'manchmal ist Load für eine zusätzliche Karte nötig
        End If
    ...
    If blnSchellAAnlegekarteGefunden = True Then
        ...
        If cdRoserlSchellA(0).CardValue + cdRoserlSchellA.Count = cdRoserlSchellA(cdRoserlSchellA.Count - 1).CardValue Then
            Load cdRoserlSchellA(cdRoserlSchellA.Count)                 'manchmal ist Load für eine zusätzliche Karte nötig
        End If
    ...
    If blnRotAssAnlegekarteGefunden = True Then
        ...
        End If
    End If
    If blnGrünAssAnlegekarteGefunden = True Then
        If strFarbe = "Grün" Then                               '3=Grün
            Load cdRoserlGrünAss(AP)
            ZielPunktLeftLorum = cdRoserlGrünAss(AP).Left               'Gerbing 25.09.2017
            ZielPunktTopLorum = cdRoserlGrünAss(AP).Top                 'Gerbing 25.09.2017
            Call MoveKarteLorum(GKP - 1)                                'Gerbing 25.09.2017
            cdRoserlGrünAss(AP).CardType = 3
            cdRoserlGrünAss(AP).CardValue = AnlegeWert
            cdRoserlGrünAss(AP).FaceMode = NachOben
            cdRoserlGrünAss(AP).Left = cdRoserlGrünAss(0).Left - (CARD_SPACE / 2 * AP)
            cdRoserlGrünAss(AP).Top = cdRoserlGrünAss(0).Top
            For I = 0 To AP
                cdRoserlGrünAss(I).ZOrder 0
                cdRoserlGrünAss(I).Left = cdRoserlGrünAss(0).Left - (CARD_SPACE / 2 * I)
                cdRoserlGrünAss(I).Visible = True
            Next I
        End If
    End If
...
'    frmMsgBox.Show 1
    ...
    End If
    If strFarbe = "Grün" Then                                       '3=Grün
        ZielPunktLeftLorum = cdRoserlGrünAss(0).Left                'Gerbing 25.09.2017
        ZielPunktTopLorum = cdRoserlGrünAss(0).Top                  'Gerbing 25.09.2017
        Call MoveKarteLorum(AssPosition - 1)                        'Gerbing 25.09.2017
        cdRoserlGrünAss(0).CardType = 3
        cdRoserlGrünAss(0).CardValue = 8
        cdRoserlGrünAss(0).FaceMode = NachOben
        cdRoserlGrünAss(0).Visible = True
    End If
    If strFarbe = "Eichel" Then                                     '4=Eichel
...
Private Sub LorumEineKarteHinlegen(Index As Integer)
    ...
    'Wenn der Ausspieler nicht mehr weiter kann, kommt als nächster Spieler der dran, der die letzte Karte einer vom
    'Ausspieler begonnenen Kartenfolge hinlegt, d.h. wenn die Kartenfolge nicht weitergeht, weil die benötigte Karte schon auf dem Tisch liegt.
    'Der Computer weis, wer die benötigte Karte hat
    'Zum Weiterspielen muss auf die Karten des vom Computer bestimmten Spielers geklickt werden
    ...
    '   Farbe gibt, die nicht höher als 3 Werte als die aktuelle ist oder nicht niedriger als 3 Werte als die aktuelle ist, die niedrigere
    ...
    blnEsGibtZwei = False
    If PlayerTurn = Spieler Then
        'beim Spieler braucht der Computer nicht zu kontrollieren ob eine Intelligenzverbesserung nötig ist
        strAbleger = "Spieler"
        For I = 1 To 8
    ...
    If LorumAuflegeFarbe = 3 Then strFarbe = "Grün"
...
'    frmMsgBox.Show 1
    ...
    If blnErsteKommtVonLinks = True And PlayerTurn = Links And LorumAufgelegtZähler = 0 Then    'Bei =0 war es die letzte einer Folge
        LorumAufgelegtZähler = 1
        blnErsteKommtVonLinks = False
        GoTo NächsteGefunden
    End If
    If blnErsteKommtVonMitte = True And PlayerTurn = Mitte And LorumAufgelegtZähler = 0 Then
        LorumAufgelegtZähler = 1
        blnErsteKommtVonMitte = False
        GoTo NächsteGefunden
    End If
    If blnErsteKommtVonRechts = True And PlayerTurn = Rechts And LorumAufgelegtZähler = 0 Then
        LorumAufgelegtZähler = 1
        blnErsteKommtVonRechts = False
        GoTo NächsteGefunden
    End If
    'Wenn Spieler selbst die erste Karte eine 4er-Folge hingelegt hat, braucht nicht gesucht zu werden wem die nächste Karte gehört
...
NächsteGefunden:
    ...
    End If
    gstrMsg = "Der nächste Ausspieler ist " & strNextPlayer & vbNewLine
    'gstrMsg = gstrMsg & "weil er die nächste zum Bilden einer Folge benötigte Karte hat" & vbNewLine
...
Private Sub mnuSpielregeln_Click()
    ...
    If retVal <= 32 Then
        ...
        gstrMsg = gstrMsg & "Diese Datei kann nicht geöffnet werden." & vbNewLine & vbNewLine
        ...
        gstrMsg = gstrMsg & "Dateinamen-Erweiterung(Datei-Typ) " & strDateinamenErweiterung & " verknüpft." & vbNewLine
        gstrMsg = gstrMsg & "Wähle selbst eine geignete Anwendung, zB mittels Windows-Explorer" & vbNewLine
        gstrMsg = gstrMsg & "Rechtklicken auf den Dateiname -> Öffnen mit... -> Programm auswählen"
        frmMsgBox.Show 1
    End If
End Sub
...
Private Sub PunkteZählen()
    ...
    lblRechts.ForeColor = &HFFFFFF
    If Spielart = Lorum Then
        'Jeder Mitspieler zählt seine Karten, das sind die Strafpunkte
    ...
    If Spielart <> Lorum Then
        For I = 1 To AKIndex
            ...
            End If
            If Spielart = RoterKönig Then
                'Der RoteKönig kostet 8 Punkte
                If AusgespielteKarten(I).cValue = 7 And AusgespielteKarten(I).cType = 2 Then                '8=König,2=Rot
                    If AusgespielteKarten(I).cEingesammeltVon = Links Then
    ...
    ElseIf Spielart = ErsterUndLetzterstich Then
        ...
        RechtsPunkte = RechtsPunkte \ 4
        SpielerPunkte = SpielerPunkte \ 4
    ElseIf Spielart = RoterKönig Then
        strSpielart = "Roter König"
    ...
    '-------------------------------------------------------------
    'Gerbing 26.07.2020
    'anstelle frmMsgBox.Show 1 soll eine neue Form frmSpielEnde benutzt werden, wo der Nutzter 'Spiel wiederholen' auswählen kann
    'frmMsgBox.Show 1
...
Private Sub MoveKarteLorum(Position As Integer)
    'Gerbing 28.07.2020
    'ich musste Facemode = NachOben ändern in FaceMode = Rückseite
    ...
    For I = 1 To myMaxMove
        If WegX < 0 And WegY > 0 Then
            If strAbleger = "Links" Then
                cdLinks(Position).FaceMode = Rückseite
            ...
            ElseIf strAbleger = "Mitte" Then
                cdMitte(Position).FaceMode = Rückseite
            ...
            ElseIf strAbleger = "Rechts" Then
                cdRechts(Position).FaceMode = Rückseite
...
Private Function VorbehandlungRotOderStiche(computercards() As cRoserl, PlayerTurn As Players, AKType As Integer)
    'Wenn ich der 4.Zugeber(der letzte eines Stiches) bin, muss ich versuchen
    'geradeso unterhalb der höchsten Karte zu bleiben, die auf dem Tisch liegt(3 liegen auf dem Tisch), nicht einfach die niedrigste zugeben
    Dim HöchsterWert As Integer
    Dim NiedrigsterWert As Integer
    Dim I As Integer
    ...
    'Welches ist die höchste Karte, die auf dem Tisch liegt?
    If PlayerTurn = Links Then
        HöchsterWert = MitteGespielt.CardValue
        If RechtsGespielt.CardValue > HöchsterWert And AKType = RechtsGespielt.CardType Then
            HöchsterWert = RechtsGespielt.CardValue
        End If
        If SpielerGespielt.CardValue > HöchsterWert And AKType = SpielerGespielt.CardType Then
            HöchsterWert = SpielerGespielt.CardValue
        End If
    ElseIf PlayerTurn = Mitte Then
        HöchsterWert = RechtsGespielt.CardValue
        If SpielerGespielt.CardValue > HöchsterWert And AKType = SpielerGespielt.CardType Then
            HöchsterWert = SpielerGespielt.CardValue
        End If
        If LinksGespielt.CardValue > HöchsterWert And AKType = LinksGespielt.CardType Then
            HöchsterWert = LinksGespielt.CardValue
        End If
    ElseIf PlayerTurn = Rechts Then
        HöchsterWert = SpielerGespielt.CardValue
        If HöchsterWert < LinksGespielt.CardValue And AKType = LinksGespielt.CardType Then
            HöchsterWert = LinksGespielt.CardValue
        End If
        If HöchsterWert < MitteGespielt.CardValue And AKType = MitteGespielt.CardType Then
            HöchsterWert = MitteGespielt.CardValue
        End If
    End If
    'HöchsterWert = höchste Karte, die auf dem Tisch liegt(3 liegen auf dem Tisch)
    'jetzt geradeso unterhalb der höchsten Karte bleiben
    NiedrigsterWert = 0
    For I = 1 To UBound(computercards)
        If AKType = computercards(I).cType Then
            MyPosition = I
            If computercards(I).cValue >= NiedrigsterWert And computercards(I).cValue <= HöchsterWert Then
                NiedrigsterWert = computercards(I).cValue
                MyPosition = I
...
Private Function VorbehandlungOber(computercards() As cRoserl, PlayerTurn As Players, AKType As Integer)
    ...
    'nicht einfach die niedrigste zugeben, sondern die höchste suchen
    Dim HöchsterWert As Integer
    Dim I As Integer
    Dim MyPosition As Integer
    ...
    For I = 1 To UBound(computercards)
        If AKType = computercards(I).cType Then
            If computercards(I).cValue = 8 Or computercards(I).cValue = 7 Then          '8=Ass 7=König Gerbing 28.11.2017
                'MyPosition = I
                If HöchsterWert < computercards(I).cValue Then
                    HöchsterWert = computercards(I).cValue
                    MyPosition = I
                End If
            End If
...
Private Function VorbehandlungRoterKönig(computercards() As cRoserl, PlayerTurn As Players, AKType As Integer)
    'Wenn der RoterKönig noch nicht gespielt ist und nicht auf dem Tisch liegt
    'und wenn ich der 4.Zugeber(der letzte eines Stiches) bin, kann ich Ass zugeben
    'nicht einfach die niedrigste zugeben, sondern die höchste suchen
    'aber nicht den Roten König                                         'Gerbing 28.11.2017
    Dim HöchsterWert As Integer
    Dim I As Integer
    Dim MyPosition As Integer
    ...
    HöchsterWert = 0
    For I = 1 To UBound(computercards)
        If computercards(I).cValue <> 7 Then                            '7=König Gerbing 28.11.2017
            If AKType = computercards(I).cType Then
                'MyPosition = I
                If HöchsterWert < computercards(I).cValue Then
                    HöchsterWert = computercards(I).cValue
        ...
        End If
    Next I
    VorbehandlungRoterKönig = MyPosition
End Function

Private Sub TimerEinsammlerLinks_Timer()
    AufrufzählerEinsammler = AufrufzählerEinsammler + 1
    If AufrufzählerEinsammler <> iMaxMove Then
        RechtsGespielt.Move EndpunktXRechts - AufrufzählerEinsammler * iMulti, EndPunktYRechts               'Bewegungsanimation nach links
        LinksGespielt.Move EndpunktXLinks - AufrufzählerEinsammler * iMulti, EndPunktYLinks                  'Bewegungsanimation nach links
        MitteGespielt.Move EndpunktXMitte - AufrufzählerEinsammler * iMulti, EndPunktYMitte                  'Bewegungsanimation nach links
        SpielerGespielt.Move EndpunktXSpieler - AufrufzählerEinsammler * iMulti, EndPunktYSpieler            'Bewegungsanimation nach links
    Else
...
Private Sub TimerEinsammlerMitte_Timer()
    AufrufzählerEinsammler = AufrufzählerEinsammler + 1
    If AufrufzählerEinsammler <> iMaxMove Then
        RechtsGespielt.Move EndpunktXRechts, EndPunktYRechts - AufrufzählerEinsammler * iMulti               'Bewegungsanimation nach oben
        LinksGespielt.Move EndpunktXLinks, EndPunktYLinks - AufrufzählerEinsammler * iMulti                  'Bewegungsanimation nach oben
        MitteGespielt.Move EndpunktXMitte, EndPunktYMitte - AufrufzählerEinsammler * iMulti                  'Bewegungsanimation nach oben
        SpielerGespielt.Move EndpunktXSpieler, EndPunktYSpieler - AufrufzählerEinsammler * iMulti            'Bewegungsanimation nach oben
    Else
...
Private Sub TimerEinsammlerRechts_Timer()
    AufrufzählerEinsammler = AufrufzählerEinsammler + 1
    If AufrufzählerEinsammler <> iMaxMove Then
        RechtsGespielt.Move EndpunktXRechts + AufrufzählerEinsammler * iMulti, EndPunktYRechts               'Bewegungsanimation nach rechts
        LinksGespielt.Move EndpunktXLinks + AufrufzählerEinsammler * iMulti, EndPunktYLinks                  'Bewegungsanimation nach rechts
        MitteGespielt.Move EndpunktXMitte + AufrufzählerEinsammler * iMulti, EndPunktYMitte                  'Bewegungsanimation nach rechts
        SpielerGespielt.Move EndpunktXSpieler + AufrufzählerEinsammler * iMulti, EndPunktYSpieler            'Bewegungsanimation nach rechts
    Else
...
Private Sub TimerEinsammlerSpieler_Timer()
    AufrufzählerEinsammler = AufrufzählerEinsammler + 1
    If AufrufzählerEinsammler <> iMaxMove Then
        RechtsGespielt.Move EndpunktXRechts, EndPunktYRechts + AufrufzählerEinsammler * iMulti               'Bewegungsanimation nach unten
        LinksGespielt.Move EndpunktXLinks, EndPunktYLinks + AufrufzählerEinsammler * iMulti                  'Bewegungsanimation nach unten
        MitteGespielt.Move EndpunktXMitte, EndPunktYMitte + AufrufzählerEinsammler * iMulti                  'Bewegungsanimation nach unten
        SpielerGespielt.Move EndpunktXSpieler, EndPunktYSpieler + AufrufzählerEinsammler * iMulti            'Bewegungsanimation nach unten
    Else
...
Private Sub TimerLinksAnimation_Timer()
    AufrufzählerLinks = AufrufzählerLinks + 1
    If AufrufzählerLinks <> iMaxMove Then
        LinksGespielt.Move StartpunktXLinks + AufrufzählerLinks * iMulti, StartPunktYLinks                  'Bewegungsanimation nach rechts
...
Private Sub TimerMitteAnimation_Timer()
    AufrufzählerMitte = AufrufzählerMitte + 1
    If AufrufzählerMitte <> iMaxMove Then
        MitteGespielt.Move StartpunktXMitte, StartPunktYMitte + AufrufzählerMitte * iMulti                  'Bewegungsanimation nach unten
...
Private Sub TimerRechtsAnimation_Timer()
    AufrufzählerRechts = AufrufzählerRechts + 1
    If AufrufzählerRechts <> iMaxMove Then
        RechtsGespielt.Move StartpunktXRechts - AufrufzählerRechts * iMulti, StartPunktYRechts               'Bewegungsanimation nach links
...
Private Sub TimerSpielerAnimation_Timer()
    AufrufzählerSpieler = AufrufzählerSpieler + 1
    If AufrufzählerSpieler <> iMaxMove Then
        SpielerGespielt.Move StartpunktXSpieler, StartPunktYSpieler - AufrufzählerSpieler * iMulti            'Bewegungsanimation nach oben
...
Private Sub SpeichernSpielstand()
    ...
    'Mit dem Menü 'Beenden' wird Roserl beendet und gleichzeitig wird der Spielstand in die Binärdatei roserl.bin gespeichert.
    'Das sind keine Zwischenspielstände, sondern der Spielstand nach jeweils einer Runde.
    'Wenn während der ersten Runde abgebrochen wird(da gibt es noch kein Runden-Ergebnis), beginnt also Roserl neu
    'Spielstand in die Binärdatei roserl.bin speichern
